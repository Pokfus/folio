...
window.FOLIO_VERSION = { v: "1.484", released: "2026-09-04T12:35Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Forty-three new cards in the Ancient Greece deck</b>, with forty-two glossary terms to go with them.",
