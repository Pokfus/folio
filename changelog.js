...
window.FOLIO_VERSION = { v: "1.756", released: "2026-09-15T10:56Z" };

window.CHANGELOG = [
  {
    d: "2026-09-15",
    t: "Thirty-eight world geography backgrounds reach back to the beginning",
    items: [
      "<b>Thirty-eight world geography backgrounds now cover their country’s whole history</b> — Somalia from the Greek merchants’ guide, Chile from Monte Verde, Romania from Trajan’s conquest of Dacia.",
      "<b>Thailand’s United Nations date was a day out on two cards</b> — the UN’s own list gives 15 December 1946, where both of them said the 16th.",
    ],
  },
  {
    d: "2026-09-14",
    ...
    items: [
      "<b>Twenty-six world geography backgrounds now cover their country\u2019s whole history</b> \u2014 from its earliest traces of people to the present, rather than the few years around independence.",
      "<b>Three United States geography backgrounds now begin with the people who were there first</b> \u2014 and run through the Spanish and Mexican years to statehood and after.",
      "<b>One Chinese province\u2019s background now runs from its Neolithic towns to the 20th century</b> \u2014 instead of beginning with a foreign lease in 1898.",
      ...
      "<b>One world geography background stated a finding backwards</b> \u2014 the paper it cites traces Egyptian ore in Nubian eye-paint, not the reverse, and the sentence now says so.",
