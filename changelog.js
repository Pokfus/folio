...
window.FOLIO_VERSION = { v: "1.535", released: "2026-09-05T11:54Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-three new cards in Ancient Rome, on the conquest of Italy, the settlement after it and the opening of the Punic wars.</b>",
      "<b>Twenty more glossary terms</b>, on the Greek south of Italy, the king it called in, his battles, the sieges that ended the war, the alliance system that followed, the roads north, and Carthage’s empire, constitution, navy and treaties with Rome, sourced.",
      "<b>Nine pictures that had failed to load now show</b> \u2014 eight on Ancient Rome cards and one on a glossary term.",
    ],
  },
  {
    d: "2026-09-04",
