...
window.FOLIO_VERSION = { v: "1.9", released: "2026-08-05T06:25Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Twenty-three new cards in the Ancient Greece deck, each with a glossary entry to go with it. They open the collection's second deck, which had been empty until now.",
    ],
  },
  {
    d: "2026-08-04",
