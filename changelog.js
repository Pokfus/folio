...
window.FOLIO_VERSION = { v: "1.585", released: "2026-09-06T04:19Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Seventeen new cards in the World History collection</b>, finishing its Byzantium deck and opening one on the Islamic world, with seventeen new glossary terms.",
    ],
  },
  {
    d: "2026-09-05",
