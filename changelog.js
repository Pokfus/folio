...
window.FOLIO_VERSION = { v: "1.354", released: "2026-08-28T20:57Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Its first hundred and thirteen cards are in, from India and China to Rome, Buenos Aires and all three South African capitals \u2014 each one a shape on a globe you can turn.",
      ...
      "<b>A language in your daily study now opens its own options</b> when you hold it \u2014 its colour, its icon, its name and the settings its decks follow.",
    ],
  },
  {
    d: "2026-08-27",
