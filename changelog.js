...
window.CHANGELOG = [
  {
    ...
    items: [
      "Nine new cards in the Ancient Greece deck, each with a glossary entry to go with it. They open the collection's second deck, which had been empty until now.",
    ],
  },
  {
    d: "2026-08-04",
