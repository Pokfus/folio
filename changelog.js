...
window.FOLIO_VERSION = { v: "1.448", released: "2026-09-04T00:03Z" };

window.CHANGELOG = [
  {
    d: "2026-09-04",
    t: "Latium’s towns join the glossary",
    items: [
      "<b>Twelve more glossary terms</b> — the Latial culture and the Latin towns around Rome, among them Lavinium, Gabii, Tusculum and Praeneste — each with sources and most with a picture.",
    ],
  },
  {
    d: "2026-09-03",
