...
window.FOLIO_VERSION = { v: "1.511", released: "2026-09-04T17:21Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Seventy new cards in the Ancient Greece deck</b>, with sixty-nine glossary terms to go with them.",
