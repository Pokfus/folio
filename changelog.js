...
window.CHANGELOG = [
  {
    ...
    items: [
      "Every card in the World History prehistory deck is now held to a minimum of five sources. Fifty-nine of the 109 already meet it and the rest are being worked through; where a card's sources genuinely cannot be found or opened, that is now recorded rather than quietly left blank.",
