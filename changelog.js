...
window.FOLIO_VERSION = { v: "1.470", released: "2026-09-04T10:16Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-nine new cards in the Ancient Greece deck</b>, with twenty-seven glossary terms to go with them.",
