...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The citation pass is finished: every one of the 109 cards in the World History prehistory deck now shows its sources, and every one meets the bar of five. Forty-six cards were worked on today — the hominins themselves, the southern African sites, the painted caves, the phases of the last ice age and the framework cards that define the periods. Where the paper announcing a find is shut behind a paywall, what usually opened it was the body responsible for the thing: a museum catalogue, a culture ministry's scholarly portal, the foundation that runs a dig. Checking the cards against those sources produced a long run of corrections, most of them dates and counts. Several ages turned out to be raw radiocarbon readings presented as calendar years, a number of figures appear in nothing that can be read openly and were dropped rather than left standing, and a few claims contradicted other cards on the site. The glossary has now begun the same job: 23 terms — those naming the human genus, its species, the best-known fossils of each, and the stone tool industries and techniques of the Old Stone Age — list at least two sources each, and checking them turned up thirteen more corrections of the same kind, two of which sent a correction back to the cards.",
    ],
  },
  {
    d: "2026-07-31",
