...
window.FOLIO_VERSION = { v: "1.564", released: "2026-09-06T00:06Z" };

window.CHANGELOG = [
  {
    d: "2026-09-06",
    t: "Seven more World War II cards, from Hitler to Lebensraum",
    items: [
      "<b>Seven new cards in the World War II collection</b>, with a glossary term for each.",
    ],
  },
  {
    d: "2026-09-05",
