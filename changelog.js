...
window.FOLIO_VERSION = { v: "1.121", released: "2026-08-08T22:31Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Sixty-seven new cards — twenty-seven in Ancient Greece, fifteen in its deck on the polis and colonisation and the first twelve of its Sparta deck, and the first forty of the <b>Ancient Rome</b> collection, in its Italy before Rome deck, which is no longer empty and can be grown a card at a time from here. Each comes with the glossary term that goes with it.",
