...
window.FOLIO_VERSION = { v: "1.463", released: "2026-09-04T03:23Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fourteen new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with nine new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
