...
window.FOLIO_VERSION = { v: "1.766", released: "2026-09-17T16:37Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Forty-seven new cards in the Russia geography collection, each with a paired glossary term and a picture.",
