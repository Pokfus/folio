...
window.FOLIO_VERSION = { v: "1.504", released: "2026-09-04T16:46Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-five new cards in the World History collection</b>, finishing its Persia and Greece decks and opening its Rome deck, with forty-three new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
