...
window.FOLIO_VERSION = { v: "1.692", released: "2026-09-10T17:55Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Ten new cards in the Second World War collection</b>, on Japan’s road to war in Asia and the crises of the 1930s, each with its own glossary term.",
    ],
  },
  {
    d: "2026-09-06",
