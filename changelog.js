...
window.FOLIO_VERSION = { v: "1.813", released: "2026-09-17T13:21Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Seventy-two more True or False answers now name their source</b> \u2014 three statements in five now carry one.",
