...
window.FOLIO_VERSION = { v: "1.819", released: "2026-09-17T13:48Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Eighty-one more True or False answers now name their source</b> \u2014 nearly two statements in three now carry one.",
