...
window.FOLIO_VERSION = { v: "1.154", released: "2026-08-10T16:39Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "A deck file may now be up to 32 MB and hold up to 8,000 cards. The two limits are there to turn away a runaway file, and the smaller of them had quietly become the real one: a 2,000-word deck studied in both directions was refused for its size while sitting well inside the card limit.",
    ],
  },
  {
    d: "2026-08-09",
