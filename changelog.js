...
window.FOLIO_VERSION = { v: "1.465", released: "2026-09-04T04:05Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixteen new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with eleven new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
