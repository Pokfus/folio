...
window.FOLIO_VERSION = { v: "1.659", released: "2026-09-06T11:16Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>The Japan collection has opened</b> with its first sixty cards, running from Jōmon Japan to the last of the great tombs.",
