...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The Ancient Greece collection has its first four cards, all in the Bronze Age Aegean deck — the Aegean Bronze Age itself, the island culture of the Cyclades, the marble figurines it is best known for, and the uninhabited island those figurines were carried to already broken — each listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
