...
window.FOLIO_VERSION = { v: "1.504", released: "2026-09-04T16:14Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-three new cards in the Ancient Greece deck</b>, with sixty-two glossary terms to go with them.",
