...
window.FOLIO_VERSION = { v: "1.533", released: "2026-09-05T11:41Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-one new cards in Ancient Rome, on the conquest of Italy, the settlement after it and the opening of the Punic wars.</b>",
      "<b>Eighteen more glossary terms</b>, on the Greek south of Italy, the king it called in, his battles, the sieges that ended the war, the alliance system that followed, the roads north and the empire and constitution of Carthage, sourced.",
