...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The Ancient Greece collection has its first eight cards, all in the Bronze Age Aegean deck — the Aegean and Cycladic Bronze Age, Crete before and during the age of the palaces, and the man who dug Knossos up and gave the Minoans their name, with the great site itself — each listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
