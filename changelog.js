...
"The list of sources in a glossary popup now starts closed, and starts closed again each time you open another term. A popup is a quick look at one word, and its sources were taking up a third of it; open the list whenever you want it. The list at the foot of a card is unchanged, and still opens by itself.",
      "On a phone the four places you go — Home, Library, Atlas, About — now sit in a bar along the bottom of the screen, named, within reach of a thumb. They were icons without labels at the top, in a strip of nine that had to be scrolled sideways to reach the last of them. The top bar keeps the settings, account and language controls, which are rarely pressed.",
      ...
      "Small things across the site: the Library no longer shows a level and a progress bar on collections that have nothing in them yet, the Settings and Account pages use the whole width of the screen rather than leaving half of it empty, the card of the day says which deck it comes from, and the “?” beside the grade buttons now lists the keyboard shortcuts — including the new one for taking a grade back.",
      ...
      "While studying you can now go back a card and take back the answer you gave it, with a button beside Exit or Ctrl+Z on a keyboard. The card returns with its answer showing, ready to be answered again, and its schedule goes back to what it was.",
