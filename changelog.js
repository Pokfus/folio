...
window.FOLIO_VERSION = { v: "1.502", released: "2026-09-04T16:13Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-three new cards in the World History collection</b>, finishing its Persia and Greece decks and opening its Rome deck, with forty-one new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
