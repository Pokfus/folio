...
window.CHANGELOG = [
  {
    d: "2026-08-03",
    t: "Fifty-four more glossary terms",
    items: [
      ...
      "Fifty-four new glossary terms on the Old Stone Age — its divisions in Africa and Eurasia, the toolmaking traditions that fill it, the painted caves and dig sites that made it, the stones and metals people worked and the way they break, the regions the story runs through, two of the people who wrote about it, the warm spells between the ice, the tools and the food that kept people alive, the great animals that lived alongside them and the lands they crossed, and how any of it gets dated — each listing the works behind it and pointing at them sentence by sentence, as every term now does. Many more spellings will now open a popup when you meet them in a card, and two terms that had been reachable under a name belonging to something else no longer answer to it.",
    ],
  },
  {
    d: "2026-08-02",
