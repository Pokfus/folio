...
window.FOLIO_VERSION = { v: "1.804", released: "2026-09-17T12:33Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Forty-six more True or False answers now name their source</b> \u2014 half the game's statements now carry one.",
