...
window.FOLIO_VERSION = { v: "1.661", released: "2026-09-06T12:38Z" };

window.CHANGELOG = [
  {
    d: "2026-09-06",
    t: "Japan opens, and the Cell in Biology",
    items: [
      "<b>The Japan collection has opened</b> with its first eighty cards, running from Jōmon Japan to the rise of the ritsuryō state.",
