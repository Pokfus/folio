...
window.FOLIO_VERSION = { v: "1.680", released: "2026-09-06T21:02Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>One hundred and twenty-one cards in the World geography collection now describe the country itself</b> — its land, its water and its climate, and its own history rather than its dealings with America.",
