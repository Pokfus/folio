...
window.FOLIO_VERSION = { v: "1.749", released: "2026-09-14T23:19Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Two new cards in the Visual Art collection</b>, the first written to the new format and the beginning of the collection again.",
