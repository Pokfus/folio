...
window.FOLIO_VERSION = { v: "1.807", released: "2026-09-17T12:43Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-three more True or False answers now name their source</b> \u2014 half the game's statements now carry one.",
