...
window.FOLIO_VERSION = { v: "1.613", released: "2026-09-06T00:15Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Three new cards in the Biology collection</b>, opening its chapter on the cell.",
      "<b>The word <i>cell</i> now opens its own glossary entry wherever it appears</b>, which it did not before.",
      "<b>Two more glossary terms</b>, written for the new cards’ answers.",
    ],
  },
  {
    d: "2026-09-05",
