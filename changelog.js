...
window.FOLIO_VERSION = { v: "1.619", released: "2026-09-06T00:07Z" };

window.CHANGELOG = [
  {
    d: "2026-09-06",
    t: "How Rome paid for its empire",
    items: [
      "<b>Three new cards in Ancient Rome</b>, on the contractors who collected the taxes, how each province was taxed, and the wealth that conquest brought back.",
      "<b>Three more glossary terms</b>, on the same subjects, sourced.",
    ],
  },
  {
    d: "2026-09-05",
