...
window.FOLIO_VERSION = { v: "1.503", released: "2026-09-04T16:04Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-two new cards in the Ancient Greece deck</b>, with sixty-one glossary terms to go with them.",
