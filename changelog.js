...
window.FOLIO_VERSION = { v: "1.656", released: "2026-09-06T03:37Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>A speed written in kilometres an hour now switches units with everything else</b>, where both figures used to be shown whatever you had chosen.",
