...
window.FOLIO_VERSION = { v: "1.513", released: "2026-09-04T20:13Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-four new cards in the World History collection</b>, finishing its Persia and Greece decks and opening its Rome deck, with fifty-two new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
