...
window.FOLIO_VERSION = { v: "1.112", released: "2026-08-08T19:15Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Fifty-eight new cards — eighteen in Ancient Greece, fifteen in its deck on the polis and colonisation and the first three of its Sparta deck, and the first forty of the <b>Ancient Rome</b> collection, in its Italy before Rome deck, which is no longer empty and can be grown a card at a time from here. Each comes with the glossary term that goes with it.",
