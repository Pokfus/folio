...
window.FOLIO_VERSION = { v: "1.510", released: "2026-09-04T18:16Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-one new cards in the World History collection</b>, finishing its Persia and Greece decks and opening its Rome deck, with forty-nine new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
