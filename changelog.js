...
window.FOLIO_VERSION = { v: "1.123", released: "2026-08-08T23:29Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Sixty-nine new cards — twenty-nine in Ancient Greece, fifteen in its deck on the polis and colonisation and the first fourteen of its Sparta deck, and the first forty of the <b>Ancient Rome</b> collection, in its Italy before Rome deck, which is no longer empty and can be grown a card at a time from here. Each comes with the glossary term that goes with it.",
