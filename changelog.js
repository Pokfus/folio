...
window.FOLIO_VERSION = { v: "1.534", released: "2026-09-05T11:49Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-two new cards in Ancient Rome, on the conquest of Italy, the settlement after it and the opening of the Punic wars.</b>",
      "<b>Nineteen more glossary terms</b>, on the Greek south of Italy, the king it called in, his battles, the sieges that ended the war, the alliance system that followed, the roads north and the empire, constitution and navy of Carthage, sourced.",
