...
window.CHANGELOG = [
  {
    d: "2026-08-02",
    t: "Twenty-five more terms, checked against their sources",
    items: [
      "Twenty-five more glossary terms now list the works behind them and point at them sentence by sentence. Reading each term against those works turned up nineteen that overstated or misremembered something: two population counts well out of date, a distance nobody could source, a much-repeated story about a historian's punishment that his own surviving letter tells rather differently, how much of Antarctica is actually bare rock, the size of the Pacific and the depth of its deepest point, the year the Fertile Crescent was given its name \u2014 which turns out to be two years earlier than everybody says \u2014 the height of Etna, and where the map that first called a continent America was really printed. All are corrected, in every language.",
