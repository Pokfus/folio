...
window.FOLIO_VERSION = { v: "1.135", released: "2026-08-09T11:05Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Folio has pictures.</b> 233 cards and 547 glossary terms now carry an illustration — a handaxe, a fresco, a portrait, a satellite view of Mesopotamia — where before there was exactly one picture on the whole site. Every one is public domain, comes from Wikimedia Commons at high resolution, and carries its title, a description and a link to the file it came from, so you can always see where it is from and check it yourself. Click any picture to open it full size. Countries are illustrated by their flag, and where nothing suitable and copyright-free could be found the card simply has no picture rather than a doubtful one.",
