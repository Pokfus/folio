...
window.CHANGELOG = [
  {
    ...
    items: [
      "The Ancient Greece collection has its first card, in the Bronze Age Aegean deck — on the Aegean Bronze Age itself, and listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
