...
window.FOLIO_VERSION = { v: "1.679", released: "2026-09-06T20:36Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>One hundred and nine cards in the World geography collection now describe the country itself</b> — its land, its water and its climate, and its own history rather than its dealings with America.",
