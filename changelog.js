...
window.FOLIO_VERSION = { v: "1.452", released: "2026-09-04T01:09Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Three new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with two new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
