...
window.FOLIO_VERSION = { v: "1.497", released: "2026-09-04T15:20Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-six new cards in the Ancient Greece deck</b>, with fifty-five glossary terms to go with them.",
