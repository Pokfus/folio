...
window.FOLIO_VERSION = { v: "1.320", released: "2026-08-27T22:44Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Two new cards, one in the <b>Ancient Greece</b> deck and one in <b>China</b>, each with a new glossary term.",
