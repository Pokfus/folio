...
window.FOLIO_VERSION = { v: "1.682", released: "2026-09-10T16:08Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Ten new cards in Ancient Rome</b>, from Marius's later consulships through the Social War to the first war with Mithridates, with ten new glossary terms.",
      "<b>Social War and Sulla now link to glossary terms of their own</b>, rather than to an Athenian war of 357 BCE and a joint entry on Marius and Sulla.",
