...
window.FOLIO_VERSION = { v: "1.509", released: "2026-09-04T16:51Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-eight new cards in the Ancient Greece deck</b>, with sixty-seven glossary terms to go with them.",
