...
window.FOLIO_VERSION = { v: "1.657", released: "2026-09-06T09:55Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>The Japan collection has opened</b> with its first forty cards, covering Jōmon Japan and the beginning of the Yayoi.",
