...
window.FOLIO_VERSION = { v: "1.409", released: "2026-08-30T06:58Z" };

window.CHANGELOG = [
  {
    d: "2026-08-30",
    t: "More China geography cards",
    items: [
      "<b>Fourteen more cards in the China geography decks</b>, seven provinces and seven capitals, each with a glossary term and a picture of its own.",
    ],
  },
  {
    d: "2026-08-29",
