...
window.FOLIO_VERSION = { v: "1.462", released: "2026-09-04T03:14Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Thirteen new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with eight new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
