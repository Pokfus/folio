...
window.FOLIO_VERSION = { v: "1.505", released: "2026-09-04T16:21Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-four new cards in the Ancient Greece deck</b>, with sixty-three glossary terms to go with them.",
