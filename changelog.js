...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so that opening one always gives you the same amount to read rather than anywhere between a sentence and a page. The first 143 are done, the countries from Afghanistan to Rwanda. Nothing has been added: what goes is the padding, chiefly the list of every neighbouring country, and on an island the distance to the nearest mainland — both of which the opening words had already told you. A typo in the entry on Bhutan went with it.",
    ],
  },
  {
    d: "2026-08-03",
