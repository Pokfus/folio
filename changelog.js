...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "On a phone, a lot less of Folio comes at you from the bottom edge. A glossary term now opens as a small window in the middle of the screen, which you can hold by its top bar and slide up or down to see the sentence it came from; a new term always opens back in the middle. The options sheets open in the middle too, and fade away instead of being cut off. You can swipe left and right to move between the home page, Collections, the Library, your account and Settings — the Atlas is left out, since a swipe there turns the globe. The grade buttons are folded to half their height by a chevron rather than by dragging their edge. On the Atlas, a place's panel is now only ever as tall as the page you are looking at needs, and shrinks when you swipe to a shorter one, so there is never a band of nothing at the bottom. And the Minigames heading is centred again.",
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so that opening one always gives you the same amount to read rather than anywhere between a sentence and a page. Every place, every person and every historical period in the glossary is now done: all 197 countries, the caves, gorges, regions, continents and oceans besides, the 54 people, and the 44 ages and stone-tool traditions — 364 entries in all, about four in five of the glossary. Almost nothing has been added: what goes is the padding, chiefly the list of every neighbouring country, on an island the distance to the nearest mainland, at a cave or dig site the account of who excavated it and when, in a life the years in office, and in a period the span of years — all of which the words around them had already told you, and much of which simply repeated the dates printed at the top of the entry. Seven entries that were too short have grown instead, each by saying something its own sources carried and it had left out. Two small errors turned up on the way and were fixed: a typo in the entry on Bhutan, and Vatican City's size given in square miles as nothing at all.",
    ],
  },
  {
    d: "2026-08-03",
