...
window.FOLIO_VERSION = { v: "1.468", released: "2026-09-04T08:54Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-seven new cards in the Ancient Greece deck</b>, with twenty-five glossary terms to go with them.",
