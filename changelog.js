...
window.FOLIO_VERSION = { v: "1.142", released: "2026-08-09T20:22Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Three new daily games</b>, taking the home page's grid to nine. <b>Crossword</b> builds a fresh grid every morning out of the cards' own answer terms, and every clue is a card's own question with the answer taken out of it — so it is the deck read sideways, answered a letter at a time. You get one check, as Timeline does, and it fills in what you missed. <b>What year?</b> lists five things that all belong to one year and gives you a timeline and three guesses to find it; guess too early and the rail tells you so and rules out everything below. And a <b>Picture round</b> asks you to name what is in five illustrations, drawn from every picture on the site — a card's, a glossary term's or an artefact's.",
