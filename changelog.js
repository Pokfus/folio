...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The home page now counts your day the way Anki does: how many cards are new, how many you are still learning, and how many are due for review, in blue, red and green — with the same three numbers beside every deck you have added, and the button beside them lined up with them. The big gold number on the daily review is that day's total rather than your level now, and turns into a tick once you have cleared it; your level is still written just underneath. On a phone the page is one column again: the daily review, then the five minigames under a heading of their own, three across; a small “Add decks” tab hangs off the review for the Library, with a quiet “About Folio” line at the foot, now that both have left the bar along the bottom of the screen. The card and glossary term of the day are no longer shown there — they are still on a computer. “Chrono” now reads “Ordered”, and the daily quote keeps its height when you turn it over to its original language, so nothing below it jumps.",
