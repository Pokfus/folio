...
window.FOLIO_VERSION = { v: "1.495", released: "2026-09-04T14:51Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-four new cards in the Ancient Greece deck</b>, with fifty-three glossary terms to go with them.",
