...
window.FOLIO_VERSION = { v: "1.7", released: "2026-08-04T22:17Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "On a phone, a lot less of Folio comes at you from the bottom edge. A glossary term now opens as a small window in the middle of the screen, with everything behind it going soft so there is only one thing to read; hold it anywhere and slide it up or down to see the sentence it came from, and double-tap it to put it away. A new term always opens back in the middle. The options sheets open in the middle too, and fade away instead of being cut off. You can swipe left and right to move between the home page, Collections, the Library, your account and Settings — the Atlas is left out, since a swipe there turns the globe. The grade buttons are folded to half their height by a chevron rather than by dragging their edge, and they now fold and unfold rather than snapping between the two. On the Atlas, a place's panel is now only ever as tall as the page you are looking at needs, and shrinks when you swipe to a shorter one, so there is never a band of nothing at the bottom. And the Minigames heading is centred again.",
