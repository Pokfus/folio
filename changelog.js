...
window.FOLIO_VERSION = { v: "1.453", released: "2026-09-04T04:20Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Seventy-two more glossary terms</b> — central Italy from the Latin towns to the volcanoes, and East Africa's fossil sites with the methods that date them, each with sources.",
    ],
  },
  {
    d: "2026-09-03",
