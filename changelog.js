...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so that opening one always gives you the same amount to read rather than anywhere between a sentence and a page. Every country in the world is done, all 197 of them; the caves, regions and continents come next. Nothing has been added: what goes is the padding, chiefly the list of every neighbouring country, and on an island the distance to the nearest mainland — both of which the opening words had already told you. Two small errors turned up on the way and were fixed: a typo in the entry on Bhutan, and Vatican City's size given in square miles as nothing at all.",
    ],
  },
  {
    d: "2026-08-03",
