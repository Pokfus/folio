...
window.FOLIO_VERSION = { v: "1.501", released: "2026-09-04T16:03Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-two new cards in the World History collection</b>, finishing its Persia and Greece decks and opening its Rome deck, with forty new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
