...
window.FOLIO_VERSION = { v: "1.465", released: "2026-09-04T05:17Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-four new cards in the Ancient Greece deck</b>, with twenty-two glossary terms to go with them.",
