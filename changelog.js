...
window.CHANGELOG = [
  {
    d: "2026-08-02",
    t: "Fifteen more terms, checked against their sources",
    items: [
      "Fifteen more glossary terms now list the works behind them and point at them sentence by sentence. Reading each term against those works turned up fourteen that overstated or misremembered something: two population counts well out of date, a distance nobody could source, a much-repeated story about a historian's punishment that his own surviving letter tells rather differently, how much of Antarctica is actually bare rock, the size of the Pacific and the depth of its deepest point, and the year the Fertile Crescent was given its name \u2014 which turns out to be two years earlier than everybody says. All are corrected, in every language.",
