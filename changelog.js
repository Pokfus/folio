...
window.FOLIO_VERSION = { v: "1.483", released: "2026-09-04T11:34Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Thirty-four new cards in the World History collection</b>, finishing its Persia and Greece decks and opening its Rome deck, with twenty-one new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
