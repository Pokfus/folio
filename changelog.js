...
window.FOLIO_VERSION = { v: "1.668", released: "2026-09-06T16:40Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Thirteen cards in the World geography collection now describe the country itself</b> — its land, its water and its climate, and its own history rather than its dealings with America.",
    ],
  },
  {
    d: "2026-09-05",
