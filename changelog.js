...
window.FOLIO_VERSION = { v: "1.669", released: "2026-09-06T16:57Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Twenty-five cards in the World geography collection now describe the country itself</b> — its land, its water and its climate, and its own history rather than its dealings with America.",
    ],
  },
  {
    d: "2026-09-05",
