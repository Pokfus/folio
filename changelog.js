...
window.FOLIO_VERSION = { v: "1.770", released: "2026-09-17T19:54Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Fifty-six new cards in the Russia geography collection, each with a paired glossary term and a picture.",
