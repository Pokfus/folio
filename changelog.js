...
window.CHANGELOG = [
  {
    d: "2026-08-02",
    t: "Forty-two more terms, checked against their sources",
    items: [
      "Forty-two more glossary terms now list the works behind them and point at them sentence by sentence. Reading each term against those works turned up twenty-two that overstated or misremembered something: two population counts well out of date, a distance nobody could source, a much-repeated story about a historian's punishment that his own surviving letter tells rather differently, how much of Antarctica is actually bare rock, the size of the Pacific and the depth of its deepest point, the year the Fertile Crescent was given its name \u2014 which turns out to be two years earlier than everybody says \u2014 the height of Etna, where the map that first called a continent America was really printed, what the British actually burned in Washington in 1814, who William Henry Harrison was really fighting at the Thames, and how many southern states actually left the Union when Lincoln was elected. All are corrected, in every language.",
