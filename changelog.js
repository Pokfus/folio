...
window.FOLIO_VERSION = { v: "1.520", released: "2026-09-05T09:43Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Eight new cards in Ancient Rome, on the conquest of Italy and the settlement after it.</b>",
      "<b>Eight more glossary terms</b>, on the Greek south of Italy, the king it called in, his battles, the sieges that ended the war and the alliance system that followed, sourced.",
