...
window.FOLIO_VERSION = { v: "1.658", released: "2026-09-06T10:27Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>The Japan collection has opened</b> with its first fifty cards, running from Jōmon Japan to the great tombs of the Kofun age.",
