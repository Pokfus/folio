...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Ten more glossary terms, and each of them was already a word Folio used without explaining: the archaeologists and anatomists who built the modern study of human origins, two East African sites at the root of the stone-tool record, a genus of heavy-jawed early humans, the numbered scheme used to compare stone technologies, and the language the Library’s first book was written in — so a term met in a card, or in Seneca, now opens rather than sitting there. All ten arrive with their sources listed, like every other entry.",
