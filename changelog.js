...
window.FOLIO_VERSION = { v: "1.11", released: "2026-08-05T05:31Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Three new cards in the Ancient Greece deck, each with a glossary entry to go with it. They open the collection's second deck, which had been empty until now.",
    ],
  },
  {
    d: "2026-08-04",
