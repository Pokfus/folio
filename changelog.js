...
window.FOLIO_VERSION = { v: "1.483", released: "2026-09-04T12:16Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Forty-two new cards in the Ancient Greece deck</b>, with forty-one glossary terms to go with them.",
