...
"The list of sources in a glossary popup now starts closed, and starts closed again each time you open another term. A popup is a quick look at one word, and its sources were taking up a third of it; open the list whenever you want it. The list at the foot of a card is unchanged, and still opens by itself.",
      ...
      "Small things across the site: the Library no longer shows a level and a progress bar on collections that have nothing in them yet, the Settings and Account pages use the whole width of the screen rather than leaving half of it empty, the card of the day says which deck it comes from, the “?” beside the grade buttons now lists the keyboard shortcuts — including the new one for taking a grade back — and a glossary popup on a phone no longer blinks out for an instant just as it finishes sliding up.",
