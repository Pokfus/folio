...
window.FOLIO_VERSION = { v: "1.12", released: "2026-08-05T05:45Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Four new cards in the Ancient Greece deck, each with a glossary entry to go with it. They open the collection's second deck, which had been empty until now.",
    ],
  },
  {
    d: "2026-08-04",
