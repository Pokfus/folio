...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Ninety-six new glossary terms. Sixty-eight on the Old Stone Age — its divisions in Africa and Eurasia, the toolmaking traditions that fill it, the painted caves and dig sites that made it, the stones and metals people worked and the way they break, the regions the story runs through, two of the people who wrote about it, the warm spells between the ice, the tools and the food that kept people alive, the great animals that lived alongside them and the lands they crossed, the named cold stages of the last ice age in Germany, the Alps and Britain, and how any of it gets dated — each listing the works behind it and pointing at them sentence by sentence, as every term now does. Many more spellings will now open a popup when you meet them in a card, and two terms that had been reachable under a name belonging to something else no longer answer to it. One of them had been left without a lifespan or a career because the only works that gave them were encyclopedias; it now has both, on the word of a national biography that says where it got them. Five terms that had been held back for want of a source they could stand on are in as well, the reference table behind three of them having turned out not to be offline but to have moved house. The other twenty-eight are on the early Holocene, the Aegean Bronze Age, the first early humans out of Africa and the small and strange human species of Asia, so every one of the new Ancient Greece cards now has an entry for its own answer, and more of the words in a card\u2019s background open where you expect them to.",
    ],
  },
  {
    d: "2026-08-02",
