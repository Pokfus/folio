...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Thirty more glossary terms, and nearly every one was already a word Folio used without explaining: the people who built the modern study of human origins, the East African sites and specimens at the root of the stone-tool record, the heavy-jawed early humans and the animals whose bones lie beside them, the brain-size line that once decided what counted as human, the numbered scheme used to compare stone technologies, the plains and conservation area around Olduvai Gorge and the people who live there, the reindeer hunters, farmers and tomb-builders of the Nordic sequence, and the language the Library’s first book was written in — so a term met in a card, or in Seneca, now opens rather than sitting there. All thirty arrive with their sources listed, like every other entry. Two of them were quietly failing to open where a card spelled them with a different capital letter, which is fixed.",
