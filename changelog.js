...
window.FOLIO_VERSION = { v: "1.508", released: "2026-09-04T16:46Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-seven new cards in the Ancient Greece deck</b>, with sixty-six glossary terms to go with them.",
