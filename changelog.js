...
window.FOLIO_VERSION = { v: "1.757", released: "2026-09-17T07:32Z" };

window.CHANGELOG = [
  {
    d: "2026-09-17",
    t: "Fifteen more federal subjects in the Russia geography collection",
    items: [
      "Fifteen new cards in the Russia geography collection, each with a paired glossary term and a picture.",
