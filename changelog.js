...
window.FOLIO_VERSION = { v: "1.436", released: "2026-08-30T16:15Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>A read-aloud button that cannot speak now says so</b>, rather than answering a press with silence.",
