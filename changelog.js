...
window.FOLIO_VERSION = { v: "1.663", released: "2026-09-06T13:32Z" };

window.CHANGELOG = [
  {
    d: "2026-09-06",
    t: "Korea opens, and the Cell in Biology",
    items: [
      "<b>A hundred and ten new cards</b>: a hundred open the Korea collection, which now sits under Collections rather than Planned, and ten open Biology’s chapter on the cell.",
      "<b>The word <i>cell</i> now opens its own glossary entry wherever it appears</b>, which it did not before.",
      "<b>A hundred and seven more glossary terms</b>, written for the new cards’ answers.",
    ],
  },
  {
    d: "2026-09-05",
