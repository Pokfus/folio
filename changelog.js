...
window.CHANGELOG = [
  {
    ...
    items: [
      "Every card in the World History prehistory deck is now held to a minimum of five sources. Fifty-six of the 109 already meet it and the rest are being worked through; where a card's sources genuinely cannot be found or opened, that is now recorded rather than quietly left blank.",
      "The cards on the three-age system and on prehistory itself now show their sources, nine works between them and every one free to read. Checking them turned up five corrections: Thomsen did not prove the order of the stone, bronze and iron ages single-handed, but was one of three Scandinavian scholars behind it, and it was his colleague Jens Jacob Worsaae who tested it in the ground and carried it across Europe; Hesiod's poem gives five races rather than three ages of metal, and the fourth of them is a race of heroes, which is why it is a story of decline and not a claim about technology; much of Africa south of the Sahara is now described as it can be checked, with iron appearing early and little sign of bronze before it, rather than as a leap straight from stone to iron; the caution that the scheme fits Europe better than anywhere else is now given in the words of John Lubbock, who wrote it; and the card on prehistory no longer says only that the word must never be used of a living community, since the scholars who work on those histories argue for retiring it altogether.",
