...
window.FOLIO_VERSION = { v: "1.774", released: "2026-09-18T00:08Z" };

window.CHANGELOG = [
  {
    d: "2026-09-18",
    t: "Ten more Russian administrative centres join the geography collection",
    items: [
      "Ten new cards in the Russia geography collection, each with a paired glossary term and a picture.",
    ],
  },
  {
    d: "2026-09-17",
