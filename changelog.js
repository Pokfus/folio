...
window.FOLIO_VERSION = { v: "1.150", released: "2026-08-10T08:26Z" };

window.CHANGELOG = [
  {
    d: "2026-08-10",
    t: "You can gather your decks into groups, the Daily study banner changes colour every day, the Iliad joins the Library with the Greek facing it, and the daily games stop asking about words nobody has heard of",
    items: [
      ...
      "<b>A Spanish deck for the DELE, at level A1.</b> 500 words, both directions in one deck as two subdecks you can add and study separately. Every noun carries its article, so you learn <i>el</i> or <i>la</i> with the word, and every verb carries its whole conjugation — the indicative, the subjunctive and the imperative, laid out tense by tense — with the reflexive verbs shown as you actually say them, <i>me llamo</i>, <i>te llamas</i>. Each word also brings three real sentences, chosen where possible to show the word in three different forms rather than the same one three times, with a speaker beside each. The word list is the A1 half of the Instituto Cervantes' own Plan curricular, the body that sets the exam.",
    ],
  },
  {
    d: "2026-08-09",
    ...
    items: [
      ...
      "<b>A card in one of your own decks can fold a section away.</b> A card type may now use the browser\u2019s own collapsible block, so a long list \u2014 example sentences, notes, a breakdown \u2014 can sit behind a heading you tap to open rather than filling the card. It needs no scripting, which a deck cannot have anyway.",
      "<b>A deck of your own can now hold up to 4,000 cards</b>, where it used to stop at 500 — enough for the largest exam level there is, studied in both directions at once. And a deck over the limit is now turned away with a reason: it used to import perfectly happily and simply be missing everything past the five hundredth card, which looks like a deck rather than like a failure.",
