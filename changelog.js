...
window.FOLIO_VERSION = { v: "1.806", released: "2026-09-17T12:41Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty more True or False answers now name their source</b> \u2014 half the game's statements now carry one.",
