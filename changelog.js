...
window.FOLIO_VERSION = { v: "1.544", released: "2026-09-05T13:19Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Nineteen new cards in the World History collection</b>, completing its Ancient India deck and opening its Ancient China deck, with twenty new glossary terms.",
    ],
  },
  {
    d: "2026-09-04",
