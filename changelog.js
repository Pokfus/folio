...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Every distance, height, area, weight and temperature on the site now gives the imperial figure after the metric one, so a reader who thinks in miles and feet is never left to convert \u2014 every card and every glossary entry, including the ones that spell the number out in words, and three figures that were the other way round have been turned around.",
