...
window.FOLIO_VERSION = { v: "1.496", released: "2026-09-04T15:11Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-five new cards in the Ancient Greece deck</b>, with fifty-four glossary terms to go with them.",
