...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so that opening one always gives you the same amount to read rather than anywhere between a sentence and a page. The first 100 are done, the countries from Afghanistan to Luxembourg. Nothing has been added: what goes is the padding, chiefly the list of every neighbouring country, which the region above it had already told you. A typo in the entry on Bhutan went with it.",
    ],
  },
  {
    d: "2026-08-03",
