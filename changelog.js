...
window.CHANGELOG = [
  {
    ...
    items: [
      "Every one of the 109 cards in the World History prehistory deck now shows its sources, and every one of them now meets the bar of five. Forty-six were worked on today. Five of them cover the hominins themselves — Australopithecus, Homo habilis, Homo ergaster, the Turkana Boy and the proposed subspecies from Herto in Ethiopia — and they were sourced mostly from museum records, because the papers that named these species are shut behind paywalls while the Smithsonian's own catalogue is open to anyone. Ten corrections came with them. Homo habilis lived from 2.4 to 1.4 million years ago rather than 2.3 to 1.5, and its brain is now given as the type specimen's own measured volume rather than a textbook range; the scholars who argued it should be moved out of our genus are named instead of left as “some researchers”. Homo ergaster loses the claim that its name is Greek for workman, which appears in nothing we could open, and loses too the list of seven traits said to mark it off from Homo erectus; in their place are the brain sizes and the dates, which show one broad range where the card had implied two. The Turkana Boy died about 1.6 million years ago rather than 1.5, his skeleton is 40 per cent complete rather than nearly whole, and the story that his bones look eleven or twelve while his teeth say eight or nine has gone: the museum that holds him says eight or nine, and that he grew at the pace of a great ape. And the Herto skulls lose three figures no source we could open supports — the pieces of seven more people, the six hundred stone tools, and the child's skull worn glossy by handling — keeping what the excavators actually reported, that all three crania carry cut marks which do not match butchery. The other three cards are the Middle Stone Age itself and two of its most famous sites, Blombos Cave and the Klasies River caves, and they came in by a route worth naming: when the paper that announced a find is shut, the paper that cites it as a comparison is often open, and it restates the find in full. Their corrections are mostly a matter of numbers. The Middle Stone Age now ends about 40,000 years ago rather than 30,000, which is what the rest of the deck already said, and its Still Bay phase is given the same dates as everywhere else on the site; the name turns out to be John Goodwin's alone, from a paper of 1928, the famous 1929 book he wrote with Clarence van Riet Lowe being where the three ages were set out; and the congress of 1955 did not simply endorse that scheme but recommended a five-part version of it, after three hours of argument and against two votes. Blombos loses a floor area and a distance from Cape Town that nothing we could open supports, in favour of the excavators' own measurements, and its nine human teeth are no longer said to identify the occupants as our species, which the paper describing them never claims. Klasies River gains a metre of deposit, two years on the date its present excavations began and the proper name of the sea snail in its middens, and it loses the reading of its cut-marked human bones as cannibalism — a real argument in the literature, but one we could not find in anything openly readable, so what stands in its place is the lopsided pattern those bones actually show. The last three are Lascaux, the Atapuerca caves in Spain and Dolní Věstonice in Moravia, long the hardest in the deck because the papers behind them are shut. What opened them was not a museum catalogue but the institution's own record: the French culture ministry publishes a scholarly portal on Lascaux, and the Atapuerca foundation a year-by-year history of the dig, and between them they carried eleven of today's citations. They also turned up the same mistake twice. Lascaux was dated to about 17,000 years ago and Dolní Věstonice to between 29,000 and 25,000, and both figures are raw radiocarbon read as calendar years: the ministry puts the painting at 21,500 to 21,000 years ago, and the Moravian burials fall between 31,270 and 29,260. Much else had to go for want of any source we could open. Lascaux loses its 1,500 engravings, its horses at 60 per cent, its 5.2-metre bull said to be the largest animal in all cave art, and its million visitors, and it gains corrections: the cave has seven sectors rather than nine galleries, one of the four discoverers was Georges Agniel rather than Agnel, and the white blight of 2001 was a fungus, not calcite. Atapuerca loses a mining railway, a shaft measured in metres and a quartzite handaxe read as an offering; its Pit of Bones now reports 29 people rather than a bone count long overtaken, and the fossil called Pink turns out to be most of a face rather than a piece of jaw. Dolní Věstonice loses the most: its first excavator's name and date, the woman buried under two mammoth shoulder blades, and the little ivory head long said to be her portrait, none of which appears in anything openly readable. What it gains is firmer: the three young people in its famous triple grave were all shown by DNA in 2016 to be male, closing a question that had been argued for decades. The last two are the Preboreal and the Boreal, the pollen zones that open the Holocene in northern Europe, and they had been expected to be the two we could not source at all. Most of what they needed turned out to be cited already on neighbouring cards, and the vegetation itself is published openly in the Netherlands. The dates then had to move. Calibrated properly, the Preboreal runs from about 11,450 to 10,150 years ago rather than 11,650 to 10,500, and the Boreal from 10,150 to 8,950 rather than 10,500 to 8,000 — a figure that had also been at odds with our own card on the Atlantic period. The Boreal used to end on the cold snap of 8,200 years ago, which in fact falls some seven centuries later, as does the drowning of Doggerland; both now read as events that follow it. The last ten are a different kind of job: cards that already showed their sources, brought up to the full five. They are the framework cards — the Stone Age, knapping, hunter-gatherers, the ice ages — together with the oldest toolmaking sites and the control of fire. Topping a card up turns out to be where the mistakes are, because the first pass only had to stand behind the sentences it had marked, and it is the unmarked ones that go unchecked. Four of the ten needed correcting. The Acheulean tool tradition ran until about 125,000 years ago rather than ending between 170,000 and 130,000, and it finished far earlier in some parts of the world than in others. The hand axe card had John Frere reporting his Suffolk find in June 1797, beneath the jawbone of an unknown beast; his own letter says as much, but that letter is locked behind a paywall, so the card now follows what can actually be read — the printed account of 1800, and the bones of giant animals. Its giant hand axes were understated too: the largest known from Britain is 32.3 centimetres, not nearly 30. The knapping card had the finest flakes pressed off with an antler tip, where the study that demonstrates the technique used a pointed piece of bone, and it treated stone-grinding as a Neolithic craft when ground tools are far older — axes with polished edges were being made in northern Australia 65,000 years ago. And the fire card gave Richard Wrangham's cooking argument a date of 1.9 million years ago where he puts it at 1.7, with its footnote pointing at a paper about something else entirely, which is worse than no footnote at all. The last seven are the ones about our own species and its nearest relatives: Homo erectus, two contested species from the middle of the family tree, the Omo skulls from Ethiopia, the Moroccan site of Jebel Irhoud, and the two nicknamed ancestors, Mitochondrial Eve and Y-chromosomal Adam. Jebel Irhoud got two new sources rather than one, because it was the only card on the site whose reading list was mostly behind paywalls, and it is now mostly open. Almost everything these seven needed came from two review articles — one on the muddled middle stretch of the human family tree, one on whether our species has a single birthplace at all — which is worth noting: when a set of cards argues over the same question rather than describing the same place, a single review tends to cover them all, because arguments are what reviews are written about. Nothing had to be corrected this time. The two nicknamed ancestors were the ones we expected to have drifted, since their dates have moved repeatedly, and both held: the man's line converges around 254,000 years ago and the woman's around 180,000, which is what the cards already said. Separately, a long-standing fault in our own tools was cleared. Every card's background is written as ten sentences, and a checker splits them so that each footnote lands on the claim it belongs to; that checker could not handle a name written with initials, so Frank H. H. Roberts and R. P. Soejono each broke a sentence in half — in English and in seven other languages. It also could not see a Chinese full stop followed by a space, which made a dozen Chinese backgrounds look like a single enormous sentence. Both are fixed, along with nine translations that had quietly turned one sentence into two, and the whole deck now reads the same way in all ten languages. The last seven are about ice and weather: the last glacial period, Doggerland, the Holocene we live in, and four of the phases and warm spells the north of Europe is divided into. This was the cheapest set of the day, and for a reason worth saying — six of its eleven new references were already on other cards, so the work was matching sentences to reading we had done before rather than finding anything new. The five that were new turned on a rule we had not met yet: when a card describes a nineteenth-century idea, the person who had the idea is often the easiest source to read, because his work is out of copyright. Axel Blytt's own account of his theory, printed in 1886, is free in full on the Internet Archive, and it settled two sentences of the card about his scheme of climate phases. It also disproved a third. The card said Blytt named the warm, wet Atlantic phase and the cool, dry Boreal, and that Rutger Sernander added two more; Blytt's paper uses neither name for a phase, and nothing we could open says who coined which. Both claims are gone. The card now says what can be checked: that Blytt read alternating wet and dry ages out of Scandinavian bogs, the peat standing for the wet times and the buried tree stumps between the peat for the dry. The last nine are the art cards — Howiesons Poort, Border Cave, the little ivory woman from Hohle Fels, cave painting itself, Chauvet, Altamira, Cosquer, the Clovis point and the petroglyph — and with them the deck is finished: all 109 cards now carry at least five sources, none is marked as unsourceable, and there is nothing left to find. Five of the thirteen references came from the bodies that look after the sites, which is where we have learned to look first: the French culture ministry for Lascaux and Chauvet, the prehistory museum at Blaubeuren, the Cosquer visitor centre in Marseille and the foundation that runs the Côa valley park. The last correction of the day is the one worth remembering. Back in July we stripped three claims from the Lascaux card, because nothing we could open supported them: its age of 17,000 years, which turned out to be a raw radiocarbon reading rather than calendar years, its 1,500 engravings and its five-metre black bull. The cave-painting card mentions Lascaux in one sentence, and it still had all three — in its background and again on its date line, in all ten languages. A correction does not travel between cards on its own, so from now on we search the whole deck for the number, not just the card it belongs to. Two things are deliberately left without a reference, and it seems better to say so than to attach a plausible one: how the team at Lomekwi took a wrong turn in July 2011, and the year the Portuguese government cancelled the dam that would have drowned the Côa engravings.",
    ],
  },
  {
    d: "2026-07-31",
    ...
    items: [
      "Every card in the World History prehistory deck is now held to a minimum of five sources. Sixty-three of the 109 already meet it and the rest are being worked through; where a card's sources genuinely cannot be found or opened, that is now recorded rather than quietly left blank.",
      "The cards on the three-age system, on prehistory itself and on the Mesolithic now show their sources — 24 works between them, every one free to read. Checking them turned up ten corrections. Thomsen did not prove the order of the stone, bronze and iron ages single-handed but was one of three Scandinavian scholars behind it, and it was his colleague Jens Jacob Worsaae who tested it in the ground and carried it across Europe; Hesiod's poem gives five races rather than three ages of metal, and the fourth of them is a race of heroes, which is why it is a story of decline and not a claim about technology; much of Africa south of the Sahara is now described as it can be checked, with iron appearing early and little sign of bronze before it; the caution that the scheme fits Europe better than anywhere else is given in the words of John Lubbock, who wrote it; and the card on prehistory no longer says only that the word must never be used of a living community, since the scholars who work on those histories argue for retiring it altogether. On the Mesolithic card, the deer-skull headdresses of Star Carr are given as 33, of which only nine were pierced, rather than 21 all pierced; the story of how the name caught on has gone, resting as it did on a study nobody can open, and in its place is what Westropp himself printed — that his three ages in 1866 ran Palaeolithic, Mesolithic and Kainolithic, the last of which he had swapped for Lubbock's Neolithic by 1872; the age now opens 9700 BCE rather than 9600, in step with the 11,700 years the rest of the deck gives for the end of the Ice Age; and the Pesse canoe and the Danish shell mounds are described only as their own heritage records and excavators describe them, without the date, the wood and the tally of mounds that no source we could open supports. The Epipalaeolithic and the Nordic Stone Age join them, and both were carrying round numbers that turn out to be something else: the fifty huts at Ain Mallaha are a published estimate of fifty to a hundred people living on a site of about 2,000 square metres, and the 2,500 Danish dolmens and passage graves out of perhaps 25,000 built appear in nothing anyone can open, so the card now describes what those tombs were — chambers that could be reopened to take the dead again and again for centuries. The Epipalaeolithic itself runs from about 23,000 to 11,600 years ago rather than the round 20,000 to 10,000, its Natufian phase ends 11,650 years ago rather than 11,500, the reindeer hunters of Scandinavia are described as their excavators describe them without the territory sizes and Norwegian dates no source we could open supports, and the flint daggers that close the Nordic Stone Age are given as the elaborate bifacial work that answered the return of metal, rather than as copies of bronze ones.",
      ...
      "Ninety-six cards in the World History prehistory deck now show their sources. At the foot of each one there is a Sources list, open and waiting, and small numbers in the background text point at the work behind that particular sentence, so you can follow any claim to the paper it came from. Every source says whether it is free to read or behind a paywall, and almost all of them are free. The four newest — on Olduvai Gorge, Java Man, Peking Man and the caves of Zhoukoudian — brought twenty-five more corrections with them: Eugène Dubois is no longer said to have given up an Amsterdam lectureship or to have taken a name from a teacher, the Dutch collection going home to Indonesia is more than 28,000 specimens rather than 40,000, and the modern-looking thigh bone from Java now has the answer fieldwork gave it in 2023, that younger river channels cut through the very spot where it lay; the Peking Man deposits open 750,000 years ago rather than 770,000, not every original bone was lost after all, and the burnt layers at Zhoukoudian were doubted through the 1980s by several studies rather than dismissed once as the work of lightning; the measurements of the great fissure there, of the Upper Cave bone needle and of the length of Olduvai Gorge are all replaced by figures a reader can check; and Wilhelm Kattwinkel, remembered ever since as a butterfly collector who stumbled on the gorge by accident in 1911, turns out to have been a doctor on a scientific expedition, with his wife Martha beside him.",
      "One hundred and seventy-two corrections found while checking those cards against their sources: the sea fell about 130 metres at the height of the last ice age, not 120; the stone tools at Jebel Irhoud are among the earliest directly dated of their kind rather than the oldest anywhere; the deposits dug at Wonderwerk Cave go down about 4 metres, not 7, which is the height of the cave itself; the oldest hand axes come from Konso in Ethiopia as well as Kokiselei in Kenya; digging with a hand axe is a suggestion rather than something the wear on them shows; the three men who settled the antiquity of humankind in 1859 went to see the Somme gravels for themselves, and one of them was an antiquary rather than a geologist; the fire-making find at Barnham is now described as its paper describes it, as heated ground, fire-cracked hand axes and two lumps of pyrite carried in from elsewhere; Homo erectus had our long legs and short arms but a deeper, wider chest, so a fully modern body came later, and the Turkana Boy is broad through the chest rather than lean; the 2021 proposal to retire the name Homo heidelbergensis would move its African fossils to a new species and its European ones, the Heidelberg jaw included, to the Neanderthals; the oldest Denisovan fossil at Denisova Cave is dated to about 195,000 years rather than at least 200,000, and reading human DNA straight out of cave earth was shown at four caves at once rather than at Denisova alone; the chute into the Rising Star cave drops about 12 metres and narrows to some 20 centimetres, and gave up 1,550 pieces rather than more than that; the claims that Homo naledi buried its dead and cut marks into the cave walls were published in 2025 with the journal's own verdict attached, one reviewer convinced and another not, rather than turned down flat and still being revised; the hobbit of Flores stood about a metre with a braincase of 426 cubic centimetres, and the arm bone published in 2024 is the shortest known for any fossil human rather than one from an adult barely a metre tall; the 2025 study of Flores puts the emptying of the cave down to drought together with competition for water rather than to the weather alone; and the very young Neanderthal dates from southern Iberia were undone by a separate re-dating study rather than by the 2014 programme, and were never about Gibraltar; and the shared male-line ancestor of every man now living is reckoned some 200,000 years further back than the card first said rather than 100,000, after a rare lineage found in Cameroon in 2013 pushed the estimate to about 338,000 years; the celebrated bone tools from Sibudu Cave are a slender point read as an arrowhead and other tools worn from stripping bark and digging, not a point and the oldest known bone needle; the record at Border Cave reaches back to about 227,000 years rather than beyond it; at the height of the last ice age the whole planet was about 6 degrees colder on average, a figure for the globe rather than for the land alone, and its air held roughly 190 parts of carbon dioxide per million rather than 180; the mammoth's teeth held the oldest DNA yet read from any animal rather than the oldest of any kind, older DNA having since been read from ancient earth itself; Africa lost about a fifth of its large animal groups in the great die-off rather than under a fifth; the warming that the Younger Dryas cut short was nearly two thousand years old rather than more than two, and central Greenland was some 10 to 14 degrees colder than today rather than 10 to 15; and the antler harpoon that began the study of Doggerland is now told as it can be checked, dredged up in a lump of peat in 1931, without the shovel-blow and the Norfolk boat that later retellings had added; northern-European summers at the warmest of the Holocene ran about one and a half degrees warmer than today rather than up to two; the greening of the Sahara is described as much of the desert rather than a precise nine million square kilometres, a figure that appears only in the press; the freshwater flood that cooled the world 8,200 years ago is no longer given an exact volume, the classic 160,000 cubic kilometres not being traceable to a source anyone can open; the last drowning of Doggerland is put down to the slow rise of the sea rather than to the Storegga tsunami, which struck during the coldest decades of that event; the collapse of the Pre-Pottery Neolithic B is described as its great sites emptying across the Levant, Syria and Anatolia, dropping an unsupported claim that its long-distance trade broke off; and the Atlantic phase's span of 8,000 to 5,000 years is marked as radiocarbon years, so it reads on the same clock as the figures beside it; Chauvet's cave-bear skulls are counted at about 190 rather than 195; at Altamira the dating of the painted ceiling stands but the rockfall said to have sealed the cave 13,000 years ago is dropped, since the dating study places that collapse far earlier; the drowned tunnel into Cosquer Cave climbs about 150 metres rather than 175, the ice-age sea there stood about 120 metres lower rather than 100, and most of the cave is under water rather than a precise four-fifths; and the Côa Valley carvings are described as open-air Ice-Age engravings found during the dam survey, without fixing their coming-to-light to the late 1980s; the name Paleo-Indian was not coined for a class of stone tools, as the card had it, but simply used in a 1940 survey that never defined it; the Folsom tradition is now given as ending about 12,300 years ago rather than 11,900, and its type site yielded 19 spear points among some 32 bison rather than 23 points, while the share of points ruined in the fluting is put at roughly 10 to 60 percent rather than 40 to 75; the Clovis point's channel runs about a third of its length rather than half, the largest known example is 24.5 centimetres rather than 23, and the stone was carried more than 900 kilometres rather than more than 1,000; Clovis points lie among mammoth or mastodon bones at about a dozen sites rather than 15, the claim that this is more than anywhere else on earth is dropped, and so are the oft-repeated tallies of 10,000 points from 1,500 places, which trace to no published count; whether Clovis knappers struck overshot flakes on purpose is now given as disputed rather than settled; spear points are described as seated in a socket of bone or ivory rather than a split shaft; Beringia's plain is given as hundreds of kilometres across rather than a thousand, its drowning is credited to the study that dated it, and the objection to the standstill is stated as scholars actually make it; Madjedbebe's 65,000-year date is set against the oldest dates from other Australian sites rather than against arrival estimates, and the genetic comparison no longer confuses the split from Eurasians with the date of settlement; at Lake Mungo the ochre burial rather than the cremation is the oldest of its kind, the burning is described as incomplete, and the contaminating sequences are counted correctly; Monte Verde's 1997 panel is said to have endorsed about 12,500 radiocarbon years, its animals are gomphotheres rather than mastodons, and the distance figure attributed to the 2026 critiques is dropped as it appears only in a newspaper; and Meadowcroft's deepest layer is given at the excavators' own 14,000 to 14,500 radiocarbon years, its disputed bark is no longer called braided basketry, and two laboratories rather than four looked for coal; two cards already carrying sources turned out to credit their source with words it does not contain, and both are fixed: the Chauvet card no longer calls the cave's two painting phases Aurignacian and Gravettian, since the study behind the dates names no culture at all, and the Sibudu card no longer calls the bone arrowhead slender, since the paper it cites gives that word to a needle and the arrowhead to a larger point; the Cro-Magnon skeletons came to light during road building rather than railway building, the skull's forehead lesion is given as a tumour or a fungal infection rather than settled, and the graves held several more newborns than the five people first counted; the Chatelperronian was defined by Henri Breuil in 1909 and named by Dorothy Garrod in 1938, rather than named by Breuil in 1906, and the 2016 protein study is no longer said to have won over the doubters, who went on publishing against it; the Aurignacian is now given as ending about 33,000 years ago rather than 26,000, its bone points are antler, and the Chauvet paintings are marked as a disputed attribution; the Gravettian no longer claims almost all Ice Age art, since the great painted caves are older or younger than it, its Moravian ceramics are among rather than simply the oldest fired clay, and the woven fibre comes from neighbouring Pavlov; the Solutrean is dated to about 25,000 to 19,000 years ago and the Magdalenian to about 21,000 to 14,000, both having been given in radiocarbon years read as calendar years, and the horses at Solutre are now described as ambushed at the foot of the rock rather than driven off it on evidence no study supports; the microlith has no agreed size limit, its Swedish bog arrow is named as the one that actually preserves the tar and the groove, and its African dates are separated so they no longer disagree with our own Howiesons Poort card; the spear-thrower's oldest definite hooks are about 20,000 years old rather than 17,500 at a site whose dating is disputed, and its speed advantage is measured against javelins rather than identical shafts; and the bow's oldest evidence is marked as a reading its own excavators call tentative, with the earliest case outside Africa now at Grotte Mandrin rather than Sri Lanka; the Divje Babe bone's defenders say no hyena was ever found at the cave, and the card now also gives the published answer to that, which is a gnawed bear bone from the cave itself; Sungir's graves are about 34,000 years old rather than spread over 34,000 to 30,000, which was the same date written twice on two different scales, the site is about 200 kilometres from Moscow and came to light in the 1950s rather than to quarrymen in 1955, the man wore 25 ivory arm bands with a dozen fox teeth at his brow rather than a cap sewn with them, the beads behind the richest graves are put at more than 2,500 hours of work rather than an hour apiece, and none of the four people whose genomes were read was a close relative of another, which is a stronger finding than the second cousins the card claimed; and at Mal'ta the famous grave held two children rather than one boy, the boy lay by the Belaya rather than the Angara, and the description of the houses and the span of the settlement have gone, neither being anything a published source states; the Lion Man's sex is no longer given as disputed, because the rebuilt figure is read as male from a sliver of ivory at the groin, its fragments reached the Museum Ulm only in 1962 rather than sitting there for thirty years, and it was rebuilt across 2012 and 2013 to a height of 31.1 centimetres, while the experiment that carved a replica is given as hundreds of hours rather than a precise 400; the Hohle Fels flute has four surviving finger holes and a fifth where it snapped, not five, and the 70 centimetres said to separate it from the ivory woman appears in nothing anyone can open; the count of more than 200 Venus figurines is gone, as is the age given for the little carved head from Brassempouy; and the Venus of Willendorf was picked out of the ground by a workman named Johann Veran rather than by Josef Szombathy, who ran the dig, the seven bands round her head are simply bands, and the claim that she cannot stand has given way to the hard iron-oxide lumps her carver had to cut around; Dmanisi's layers are given as about 1.8 million years old rather than as a span from 1.85 to 1.77 million, the smallest of its braincases is given at its published 546 cubic centimetres instead of a range reaching 730, the comparison likening the spread of its five skulls to five modern people is not what its describers wrote, and the site is now said to hold the oldest human fossils outside Africa, since cut-marked bones in Romania are claimed to show people in Eurasia earlier still; and the Aterian toolkit of North Africa ran on until about 30,000 years ago rather than 20,000, with the worked bone at Contrebandiers dated between 120,000 and 90,000 years ago rather than 122,000 and 96,000; and two cards that sum up whole periods have been brought into line with the rest of the deck, so the Old Stone Age now ends 11,700 years ago everywhere instead of 12,000 years ago on two cards, and the oldest known animal painting on Sulawesi is given as at least 45,500 years old with a narrative scene nearby at 51,200 — the figures our own cave-painting card already carried.; the Toba eruption is now given as about 5,300 cubic kilometres of magma rather than 2,800 of rock and ash, the six-year volcanic winter is dropped for the thousand years of extreme cold that Ambrose actually proposed, the mud of Lake Malawi is said to record a cooling of about 1.5 degrees rather than none at all, and the newer climate models are described as they read, a sharp global chill with Africa and India among the mildest places on the map; and the two Levantine caves are corrected throughout, Skhul dug in 1931 and 1932 rather than from 1929, Qafzeh dated in 1988 and Skhul in 1993 rather than both in the 1980s, Qafzeh alone yielding 27 people, the Skhul 5 skull carrying an unbroken bar of bone above the eyes rather than heavy brows, the Neanderthals of Kebara and Amud placed in the same corridor at 70,000 to 50,000 years ago, the Qafzeh child lying on its back in a pit with the arms bent rather than curled in a hollow cut into the rock, the boar's jaw held in a man's arms rather than laid on his chest, and the sea shells at both caves holed by nature rather than pierced, though worn from being strung.; Pinnacle Point lies just west of the town of Mossel Bay and not just south of it, the temperature it heated its stone to is dropped, since no source we can open gives one, and that heating is now said to appear there 164,000 years ago and to take over the stone tools by 72,000, rather than to be first recorded in the later of the two caves; burnt lumps of ochre at Stone Age sites are read as deliberately reddened rather than shown to be; and the call to drop the checklist of modern behaviour is no longer put in one scholar's mouth, since the paper it came from cannot be opened, and rests instead on a study that makes the same case in the open. And two naming stories are narrowed to what their sources actually say: the flints that gave the Levallois method its name came out of the gravel quarries near Paris during the 19th century rather than in the 1860s and 1870s, and Le Moustier is now described as the shelters whose flint tools Lartet and Christy published in the 1860s and 1870s, and as the industry's type site to this day, rather than as dug from 1863 and named in 1869 — dates that rest on a journal nobody here can open.",
    ],
  },
  {
    d: "2026-07-30",
