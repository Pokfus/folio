...
window.FOLIO_VERSION = { v: "1.621", released: "2026-09-06T00:49Z" };

window.CHANGELOG = [
  {
    d: "2026-09-06",
    t: "How Rome paid for its empire, and the crisis that followed",
    items: [
      "<b>Twenty-three new cards in Ancient Rome</b>, on tax contractors and provincial revenue, Greek influence and Cato, the Bacchanalia, and the Gracchi from the land bill to the killings that answered it.",
      "<b>Twenty-three more glossary terms</b>, on the same subjects, sourced.",
    ],
  },
  {
    d: "2026-09-05",
   ...
   "<b>A hundred and five new cards in Ancient Rome, on the conquest of Italy, the settlement after it, the Punic wars and the Greek east.</b>",
      "<b>A hundred and two more glossary terms</b>, on the Greek south of Italy, Pyrrhus and his battles, the alliance system that followed, the roads north, and Carthage’s empire, navy, generals and wars with Rome, sourced.",
  ...
  },
  {
    ...
    items: [
      ...
      "<b>Sixty-two new cards in Ancient Rome, opening the conquest of Italy.</b>",
      "<b>193 more glossary terms</b> — central Italy and its provinces, East Africa’s fossil sites, Egypt from the Nile to Amarna, the struggle between the Roman orders, and the vocabulary of states, diplomacy and government, all sourced.",
    ],
  },
  {
    d: "2026-09-03",
    ...
    items: [
      ...
      "<b>Eighty-six more glossary terms</b> — Greek pottery and regions, the sites of Crete and Cyprus, ancient materials, and Rome’s institutions and hills — each with sources and most with a picture.",
    ],
  },
  {
    d: "2026-08-31",
