...
window.FOLIO_VERSION = { v: "1.409", released: "2026-08-30T09:51Z" };

window.CHANGELOG = [
  {
    d: "2026-08-30",
    t: "Nineveh, its canals and its library",
    items: [
      "Fourteen new cards in the <b>World History</b> collection, in its Iron Age Near East deck.",
      "Thirteen new glossary terms.",
    ],
  },
  {
    d: "2026-08-29",
    ...
    items: [
      "Thirty-two new cards in the <b>World History</b> collection, finishing its Bronze Age world deck and opening its Iron Age Near East one.",
      "Sixteen new glossary terms, most of them Bronze Age.",
