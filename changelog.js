...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The Ancient Greece collection has its first three cards, all in the Bronze Age Aegean deck — the Aegean Bronze Age itself, the island culture of the Cyclades, and the marble figurines it is best known for — each listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
