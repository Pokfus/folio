...
window.FOLIO_VERSION = { v: "1.768", released: "2026-09-17T18:07Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Fifty-one new cards in the Russia geography collection, each with a paired glossary term and a picture.",
