...
window.FOLIO_VERSION = { v: "1.769", released: "2026-09-17T18:56Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Fifty-three new cards in the Russia geography collection, each with a paired glossary term and a picture.",
