...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so that opening one always gives you the same amount to read rather than anywhere between a sentence and a page. Every place in the glossary is now done: all 197 countries, and the caves, gorges, regions, continents and oceans besides — 266 entries in all. Nothing has been added: what goes is the padding, chiefly the list of every neighbouring country, on an island the distance to the nearest mainland, and at a cave or dig site the account of who excavated it and when — all of which the words around them had already told you, and several of which simply repeated the dates printed at the top of the entry. Two small errors turned up on the way and were fixed: a typo in the entry on Bhutan, and Vatican City's size given in square miles as nothing at all.",
    ],
  },
  {
    d: "2026-08-03",
