...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The Ancient Greece collection has its first nine cards, all in the Bronze Age Aegean deck — the Aegean and Cycladic Bronze Age, Crete before and during the age of the palaces, the man who dug Knossos up and gave the Minoans their name, the great site itself, and what a Minoan palace actually is as a building — each listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
