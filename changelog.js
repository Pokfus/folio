...
window.CHANGELOG = [
  {
    ...
    items: [
      "The Ancient Greece collection has its first two cards, both in the Bronze Age Aegean deck — the Aegean Bronze Age itself, and the island culture of the Cyclades — each listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
