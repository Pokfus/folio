...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "When the Gloss of the day on the home page has a picture, it now fills the right-hand side of the tile as a portrait. In a term's own panel the picture is shown whole rather than trimmed to fit a fixed frame: every one appears at the same height, with the width following the shape of the picture.",
    ],
  },
  {
    d: "2026-07-27",
