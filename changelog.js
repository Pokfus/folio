...
window.FOLIO_VERSION = { v: "1.472", released: "2026-09-04T05:22Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty-three new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with fifteen new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
