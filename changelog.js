...
window.FOLIO_VERSION = { v: "1.873", released: "2026-09-18T03:08Z" };

window.CHANGELOG = [
  {
    d: "2026-09-18",
    t: "A new collection: the flags of the world\u2019s countries and territories",
    items: [
      ...
      "<b>Thirty-nine new cards in the Flags deck</b>, from India to Angola.",
      "<b>A flag card no longer shows the flag twice</b> \u2014 the answer box has none, and the credit sits under the flag on the question.",
