...
window.FOLIO_VERSION = { v: "1.458", released: "2026-09-04T02:29Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Nine new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with four new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
