...
window.FOLIO_VERSION = { v: "1.821", released: "2026-09-17T14:34Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Eighty-three more True or False answers now name their source</b> \u2014 two statements in three now carry one.",
