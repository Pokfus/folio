...
window.FOLIO_VERSION = { v: "1.693", released: "2026-09-10T19:18Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Twenty new cards in the China deck</b>, taking the Qin from its buried law books to the fall of the dynasty and opening the Han with Xiang Yu, Gaozu and Empress Lü.",
      "Eighteen more glossary terms, for the Qin roads, walls and mausoleum, the fall of the dynasty and the founding of the Han.",
