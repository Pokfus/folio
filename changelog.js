...
window.FOLIO_VERSION = { v: "1.763", released: "2026-09-17T11:42Z" };

window.CHANGELOG = [
  {
    d: "2026-09-17",
    t: "Forty more federal subjects in the Russia geography collection",
    items: [
      "Forty new cards in the Russia geography collection, each with a paired glossary term and a picture.",
