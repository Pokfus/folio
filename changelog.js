...
window.FOLIO_VERSION = { v: "1.499", released: "2026-09-04T15:32Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-eight new cards in the Ancient Greece deck</b>, with fifty-seven glossary terms to go with them.",
