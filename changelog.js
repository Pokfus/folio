...
window.FOLIO_VERSION = { v: "1.364", released: "2026-08-28T13:19Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Twenty-four wrong first names</b> were corrected in the citation lists of eighteen studies, across the cards and the glossary alike.",
      "<b>Psychology has opened</b>, under a new Science heading on the Collections page, with its first thirty-eight cards and thirty-seven new glossary terms.",
    ],
  },
  {
    d: "2026-08-27",
