...
window.FOLIO_VERSION = { v: "1.494", released: "2026-09-04T14:42Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-three new cards in the Ancient Greece deck</b>, with fifty-two glossary terms to go with them.",
