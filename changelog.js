...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The home page now counts your day the way Anki does: how many cards are new, how many you are still learning, and how many are due for review, in blue, red and green — with the same three numbers beside every deck you have added. The big gold number on the daily review is that day's total rather than your level now, and turns into a tick once you have cleared it; your level is still written just underneath. On a phone the dots for swiping between the review, the games and the day's card have moved above them, the panes no longer touch as you swipe past, and the Library banner sits with the review where it belongs, with a quiet “About Folio” line under it now that About has left the bar along the bottom of the screen. “Chrono” now reads “Ordered”, and the daily quote keeps its height when you turn it over to its original language, so nothing below it jumps.",
      "The pen for drawing on a card is easier to use on a phone. It no longer sits on top of the bar along the bottom of the screen; the three sizes are the pen itself, so tapping the size you are using puts it away; Mark sits beside them; and there is a colour of your own to pick, which is remembered. Show answer, the grade buttons and the row beneath them can be tapped with the pen down instead of being covered by the drawing layer. Starting a card no longer opens the keyboard by itself. And on the Atlas a place's panel can be dragged taller or shorter by its top edge, and opens at the height you left it.",
    ],
  },
  {
    d: "2026-08-01",
