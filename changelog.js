...
window.FOLIO_VERSION = { v: "1.454", released: "2026-09-04T04:54Z" };

window.CHANGELOG = [
  {
    d: "2026-09-04",
    t: "Central Italy and the East African plains join the glossary",
    items: [
      "<b>Eighty-four more glossary terms</b> — central Italy from the Latin towns to the volcanoes, East Africa's fossil sites and how they are dated, and Egypt from the Nile to Amarna, each with sources.",
    ],
  },
  {
    d: "2026-09-03",
