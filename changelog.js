...
window.FOLIO_VERSION = { v: "1.760", released: "2026-09-17T09:20Z" };

window.CHANGELOG = [
  {
    d: "2026-09-17",
    t: "Twenty-five more federal subjects in the Russia geography collection",
    items: [
      "Twenty-five new cards in the Russia geography collection, each with a paired glossary term and a picture.",
