...
window.FOLIO_VERSION = { v: "1.798", released: "2026-09-17T21:00Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      ,"<b>A hundred and fifty new cards and fifty glossary terms</b> — a hundred on the politics of East Asia in a new Special section, and fifty on Augustus and the Julio-Claudians."
      ,"<b>Thirty-six citations now give the right publication year</b> — a run of references to Tacitus named the wrong volume of the same edition."
    ]
  },
  {
    d: "2026-09-15",
