...
window.FOLIO_VERSION = { v: "1.812", released: "2026-09-17T13:18Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Seventy more True or False answers now name their source</b> \u2014 three statements in five now carry one.",
