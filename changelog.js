...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so opening one always gives you the same amount to read rather than anywhere between a sentence and a page. Nearly all of it is done — 449 entries, nineteen in twenty: all 197 countries, the caves, regions, continents and oceans besides, the 54 people, the 44 ages and stone-tool traditions, the 40 human species, fossils and animals, and the 45 tools, artworks, cultures and peoples. Almost nothing has been added: what goes is the padding — a country's list of neighbours, an island's distance from the mainland, a dig site's account of who excavated it, a tool's second explanation of how it worked, a period's span of years — most of which the words around it had already told you, and much of which simply repeated the dates printed at the top. Nine entries that were too short have grown instead, each by saying something its own sources carried and it had left out; two small errors turned up on the way and were fixed.",
    ],
  },
  {
    d: "2026-08-03",
