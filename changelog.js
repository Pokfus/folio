...
window.FOLIO_VERSION = { v: "1.488", released: "2026-09-04T13:09Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Forty-seven new cards in the Ancient Greece deck</b>, with forty-seven glossary terms to go with them.",
