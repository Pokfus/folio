...
window.FOLIO_VERSION = { v: "1.772", released: "2026-09-17T21:32Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Sixty-nine new cards in the Russia geography collection, each with a paired glossary term and a picture.",
