...
window.FOLIO_VERSION = { v: "1.762", released: "2026-09-17T10:39Z" };

window.CHANGELOG = [
  {
    d: "2026-09-17",
    t: "Thirty-five more federal subjects in the Russia geography collection",
    items: [
      "Thirty-five new cards in the Russia geography collection, each with a paired glossary term and a picture.",
