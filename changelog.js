...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Fifteen cards in the World History prehistory deck now show their sources. At the foot of each one there is a Sources list you can open, and small numbers in the background text point at the work behind that particular sentence, so you can follow any claim to the paper it came from. Every source says whether it is free to read or behind a paywall, and almost all of them are free.",
      "Ten corrections found while checking those cards against their sources: the sea fell about 130 metres at the height of the last ice age, not 120; the stone tools at Jebel Irhoud are among the earliest directly dated of their kind rather than the oldest anywhere; the deposits dug at Wonderwerk Cave go down about 4 metres, not 7, which is the height of the cave itself; the oldest hand axes come from Konso in Ethiopia as well as Kokiselei in Kenya; digging with a hand axe is a suggestion rather than something the wear on them shows; the three men who settled the antiquity of humankind in 1859 went to see the Somme gravels for themselves, and one of them was an antiquary rather than a geologist; the fire-making find at Barnham is now described as its paper describes it, as heated ground, fire-cracked hand axes and two lumps of pyrite carried in from elsewhere; Homo erectus had our long legs and short arms but a deeper, wider chest, so a fully modern body came later, and the Turkana Boy is broad through the chest rather than lean; and the 2021 proposal to retire the name Homo heidelbergensis would move its African fossils to a new species and its European ones, the Heidelberg jaw included, to the Neanderthals.",
    ],
  },
  {
    d: "2026-07-30",
