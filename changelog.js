...
window.FOLIO_VERSION = { v: "1.655", released: "2026-09-06T03:31Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Thirty new cards</b>: twenty open the Korea collection, which now sits under Collections rather than Planned, and ten open Biology’s chapter on the cell.",
      "<b>The word <i>cell</i> now opens its own glossary entry wherever it appears</b>, which it did not before.",
      "<b>Twenty-seven more glossary terms</b>, written for the new cards’ answers.",
    ],
  },
  {
    d: "2026-09-05",
