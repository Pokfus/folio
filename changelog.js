...
window.FOLIO_VERSION = { v: "1.531", released: "2026-09-05T11:17Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Nineteen new cards in Ancient Rome, on the conquest of Italy, the settlement after it and the opening of the Punic wars.</b>",
      "<b>Sixteen more glossary terms</b>, on the Greek south of Italy, the king it called in, his battles, the sieges that ended the war, the alliance system that followed and the roads north, sourced.",
