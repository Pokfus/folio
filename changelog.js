...
window.FOLIO_VERSION = { v: "1.489", released: "2026-09-04T13:20Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Forty-eight new cards in the Ancient Greece deck</b>, with forty-seven glossary terms to go with them.",
