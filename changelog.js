...
window.FOLIO_VERSION = { v: "1.654", released: "2026-09-06T02:19Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Twenty new cards</b>: ten open the Korea collection, which now sits under Collections rather than Planned, and ten open Biology’s chapter on the cell.",
      "<b>The word <i>cell</i> now opens its own glossary entry wherever it appears</b>, which it did not before.",
      "<b>Eighteen more glossary terms</b>, written for the new cards’ answers.",
    ],
  },
  {
    d: "2026-09-05",
