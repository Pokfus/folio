...
window.FOLIO_VERSION = { v: "1.814", released: "2026-09-17T13:27Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Seventy-three more True or False answers now name their source</b> \u2014 three statements in five now carry one.",
