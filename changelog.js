...
window.FOLIO_VERSION = { v: "1.692", released: "2026-09-10T17:53Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Thirteen cards in the Ancient Greece deck now rest on a wider range of sources rather than mostly on one.",
