...
window.FOLIO_VERSION = { v: "1.506", released: "2026-09-04T16:33Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-five new cards in the Ancient Greece deck</b>, with sixty-four glossary terms to go with them.",
