...
"The list of sources in a glossary popup now starts closed, and starts closed again each time you open another term. A popup is a quick look at one word, and its sources were taking up a third of it; open the list whenever you want it. The list at the foot of a card is unchanged, and still opens by itself.",
      "On a phone every page — Home, Library, Atlas, About, your account, Settings, and the editor for those who have one — now sits in a bar along the bottom of the screen, named, within reach of a thumb. They were icons without labels at the top, in a strip of nine that had to be scrolled sideways to reach the last of them. The top bar has gone from phones altogether: light and dark, and the language you read in, now live on the Settings page, where they are easy to find on any screen.",
      ...
      "On a phone, a place's panel on the Atlas is now read by swiping sideways through its parts — the description, the year, the figures, the sources — instead of scrolling down past all of them, and it always opens on the description. Dots under the panel say how many parts there are and take you straight to one.",
