...
window.FOLIO_VERSION = { v: "1.545", released: "2026-09-05T13:07Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Thirty-three new cards in Ancient Rome, on the conquest of Italy, the settlement after it and the Punic wars.</b>",
      "<b>Thirty more glossary terms</b>, on the Greek south of Italy, the king it called in, his battles, the sieges that ended the war, the alliance system that followed, the roads north, and Carthage’s empire, constitution, navy and wars with Rome, sourced.",
