...
window.FOLIO_VERSION = { v: "1.498", released: "2026-09-04T15:26Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifty-seven new cards in the Ancient Greece deck</b>, with fifty-six glossary terms to go with them.",
