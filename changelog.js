...
window.FOLIO_VERSION = { v: "1.507", released: "2026-09-04T16:40Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Sixty-six new cards in the Ancient Greece deck</b>, with sixty-five glossary terms to go with them.",
