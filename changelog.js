...
window.FOLIO_VERSION = { v: "1.692", released: "2026-09-10T18:11Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Twenty-one cards in the Ancient Greece deck now rest on a wider range of sources rather than mostly on one.",
