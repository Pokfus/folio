...
window.FOLIO_VERSION = { v: "1.383", released: "2026-08-29T13:16Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Five new cards in the <b>World History</b> collection, each with a new glossary term to go with it, finishing its Indus and early China deck.",
