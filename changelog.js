...
window.FOLIO_VERSION = { v: "1.455", released: "2026-09-04T01:49Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Six new cards in the World History collection</b>, finishing its Iron Age Near East and Persia deck and opening its Greece deck, with two new glossary terms.",
    ],
  },
  {
    d: "2026-09-03",
