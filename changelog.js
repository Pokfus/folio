...
window.FOLIO_VERSION = { v: "1.767", released: "2026-09-17T17:26Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Forty-nine new cards in the Russia geography collection, each with a paired glossary term and a picture.",
