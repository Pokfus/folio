...
window.FOLIO_VERSION = { v: "1.447", released: "2026-09-04T00:36Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Another 71 corrections to the Canterbury Tales</b>, where the scan had read one mark as a 1 and it turned out to be three different things.",
    ],
  },
  {
    d: "2026-09-03",
