...
window.FOLIO_VERSION = { v: "1.823", released: "2026-09-17T15:10Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Ninety-two more True or False answers now name their source</b> \u2014 seven statements in ten now carry one.",
