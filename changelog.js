...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Glossary entries are being brought to an even length — about a hundred words each — so that opening one always gives you the same amount to read rather than anywhere between a sentence and a page. Most of the glossary is now done — 404 entries, about six in seven: all 197 countries, the caves, gorges, regions, continents and oceans besides, the 54 people, the 44 ages and stone-tool traditions, and the 40 human species, fossils and animals. Almost nothing has been added: what goes is the padding, chiefly the list of every neighbouring country, on an island the distance to the nearest mainland, at a cave or dig site the account of who excavated it and when, in a life the years in office, and in a period or a species the span of years — all of which the words around them had already told you, and much of which simply repeated the dates printed at the top of the entry. Nine entries that were too short have grown instead, each by saying something its own sources carried and it had left out. Two small errors turned up on the way and were fixed: a typo in the entry on Bhutan, and Vatican City's size given in square miles as nothing at all.",
    ],
  },
  {
    d: "2026-08-03",
