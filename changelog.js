...
window.FOLIO_VERSION = { v: "1.771", released: "2026-09-17T20:24Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "Fifty-nine new cards in the Russia geography collection, each with a paired glossary term and a picture.",
