...
window.FOLIO_VERSION = { v: "1.660", released: "2026-09-06T11:50Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>The Japan collection has opened</b> with its first seventy cards, running from Jōmon Japan to the Taika Reform.",
