...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "True or False now reads in Spanish, French, German, Italian, Dutch, Russian, Arabic and Chinese — the statement, its category and the explanation that follows. The other languages are on their way; until then that game stays in English for them.",
    ],
  },
  {
    d: "2026-07-27",
