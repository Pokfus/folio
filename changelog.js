...
window.FOLIO_VERSION = { v: "1.693", released: "2026-09-10T19:07Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Twenty new cards in the Second World War collection</b>, on Japan’s road to war in Asia and the crises of the 1930s from Spain to Munich, each with its own glossary term.",
    ],
  },
  {
    d: "2026-09-06",
