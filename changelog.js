...
window.FOLIO_VERSION = { v: "1.540", released: "2026-09-05T11:52Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Fifteen new cards in the World History collection</b>, completing its Ancient India deck and opening its Ancient China deck, with fifteen new glossary terms.",
    ],
  },
  {
    d: "2026-09-04",
