...
window.FOLIO_VERSION = { v: "1.749", released: "2026-09-14T21:49Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "<b>Five new cards in the World History collection</b>, finishing its South and Southeast Asia deck with the monuments, ships and spice trade of the eastern seas, each with its own glossary term.",
    ],
  },
  {
    d: "2026-09-13",
