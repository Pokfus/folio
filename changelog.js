...
window.FOLIO_VERSION = { v: "1.118", released: "2026-08-08T21:14Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "Sixty-four new cards — twenty-four in Ancient Greece, fifteen in its deck on the polis and colonisation and the first nine of its Sparta deck, and the first forty of the <b>Ancient Rome</b> collection, in its Italy before Rome deck, which is no longer empty and can be grown a card at a time from here. Each comes with the glossary term that goes with it.",
