...
window.FOLIO_VERSION = { v: "1.779", released: "2026-09-24T10:43Z" };

window.CHANGELOG = [
  {
    d: "2026-09-24",
    t: "Three more Russian administrative centres",
    items: [
      "Three new cards in the Russia geography collection, each with a paired glossary term and a picture.",
      "A cited book\u2019s title is corrected in the sources of thirteen Russia geography cards.",
    ],
  },
  {
    d: "2026-09-18",
    t: "Thirty-two more Russian administrative centres",
    items: [
  ...
  {
    d: "2026-09-17",
    t: "The Russia geography collection reaches its first city card",
    items: [
