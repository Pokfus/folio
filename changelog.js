...
window.FOLIO_VERSION = { v: "1.805", released: "2026-09-17T12:35Z" };
...
window.CHANGELOG = [
  {
    ...
    items: [
      "<b>Forty-eight more True or False answers now name their source</b> \u2014 half the game's statements now carry one.",
