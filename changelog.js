...
window.CHANGELOG = [
  {
    ...
    items: [
      ...
      "The Ancient Greece collection has its first five cards, all in the Bronze Age Aegean deck — the Aegean Bronze Age itself, the island culture of the Cyclades, the marble figurines it is best known for, the uninhabited island those figurines were carried to already broken, and Crete in the centuries before it had any palace — each listing the works behind it as every card does. The collection can now be studied rather than sitting empty.",
