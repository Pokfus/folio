...
const EXTENT_PLACES = {
  ...
  "gr-383": {victors: {in: [["Ecbatana",48.51,34.8],["Susa",48.25,32.19],["Pasargadae",53.18,30.19]], out: [["Sardis",28.04,38.49],["Babylon",44.42,32.54]]}, losers: {in: [["Sardis",28.04,38.49],["Ephesus",27.34,37.94],["Miletus",27.28,37.53]], out: [["Ecbatana",48.51,34.8],["Tarsus",34.89,36.92]]}},
  "gr-676": {victors: {in: [["Chios",26.14,38.37],["Rhodes",28.22,36.44],["Byzantium",28.98,41.01]], out: [["Athens",23.73,37.98],["Samos",26.98,37.75]]}, losers: {in: [["Athens",23.73,37.98],["Piraeus",23.65,37.94],["Eleusis",23.54,38.04]], out: [["Sparta",22.43,37.07],["Chios",26.14,38.37]]}},
  "rm-158": {victors: {in: [["Rome",12.48,41.9],["Capua",14.22,41.1],["Tibur",12.8,41.96]], out: [["Tarquinii",11.76,42.26],["Arretium",11.88,43.46]]}, losers: {in: [["Tarquinii",11.76,42.26],["Volsinii",12.11,42.72],["Arretium",11.88,43.46]], out: [["Rome",12.48,41.9],["Veii",12.38,42.03]]}},
  "rm-159": {victors: {in: [["Rome",12.48,41.9],["Capua",14.22,41.1],["Neapolis",14.25,40.85]], out: [["Mevania",12.61,42.93],["Asculum",13.57,42.85]]}, losers: {in: [["Mevania",12.61,42.93],["Iguvium",12.58,43.35],["Asculum",13.57,42.85]], out: [["Rome",12.48,41.9],["Arretium",11.88,43.46]]}},
  "rm-261": {victors: {in: [["Rome",12.48,41.9],["Naples",14.25,40.85],["Florence",11.25,43.77]], out: [["Numantia",-2.45,41.81],["Olisipo",-9.14,38.72]]}, losers: {in: [["Numantia",-2.45,41.81],["Olisipo",-9.14,38.72],["Emerita",-6.34,38.92]], out: [["Tarraco",1.25,41.12],["Gades",-6.29,36.53]]}},
  "cnh-205": {victors: {in: [["Xianyang",108.71,34.33],["Luoyang",112.45,34.62],["Linzi",118.31,36.83]], out: [["Panyu",113.26,23.13],["Hanoi",105.85,21.03]]}, losers: {in: [["Panyu",113.26,23.13],["Hanoi",105.85,21.03],["Hepu",109.19,21.67]], out: [["Changsha",112.94,28.23],["Xianyang",108.71,34.33]]}},
  "wh-463": {victors: {in: [["Mecca",39.826,21.423],["Medina",39.611,24.467],["Sanaa",44.206,15.355]], out: [["Jerusalem",35.22,31.78],["Ctesiphon",44.58,33.09]]}, losers: {in: [["Constantinople",28.98,41.01],["Alexandria",29.92,31.20],["Ctesiphon",44.58,33.09]], out: [["Mecca",39.826,21.423],["Carthage",10.32,36.85]]}},
  "wh-310": {victors: {in: [["Pella",22.53,40.76],["Thessalonica",22.94,40.64],["Pydna",22.62,40.4]], out: [["Sardis",28.04,38.49],["Babylon",44.42,32.54]]}, losers: {in: [["Sardis",28.04,38.49],["Babylon",44.42,32.54],["Persepolis",52.89,29.94]], out: [["Pella",22.53,40.76],["Athens",23.73,37.98]]}},
  "cnh-103": {victors: {in: [["Feng",108.70,34.30],["Zhouyuan",107.62,34.52],["Baoji",107.14,34.36]], out: [["Anyang",114.35,36.10],["Zhengzhou",113.63,34.75]]}, losers: {in: [["Anyang",114.35,36.10],["Zhengzhou",113.63,34.75],["Chaoge",114.20,35.62]], out: [["Feng",108.70,34.30],["Baoji",107.14,34.36]]}},
  "us-071": {victors: {in: [["Philadelphia",-75.16,39.95],["Albany",-73.76,42.65],["Boston",-71.06,42.36]], out: [["Newtown",-76.83,42.07],["Canandaigua",-77.28,42.89]]}, losers: {in: [["Newtown",-76.83,42.07],["Canandaigua",-77.28,42.89],["Genesee Castle",-77.87,42.79]], out: [["Onondaga",-76.15,43.05],["Albany",-73.76,42.65]]}},
};
