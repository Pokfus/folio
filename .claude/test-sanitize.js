...
const VECTORS = [
  ...
  // style survives only as a colour (the rich-text ribbon emits <span style="color:…">)
  ["style attribute stripped", '<p style="position:fixed;top:0">x</p>', ["style", "position:fixed"], ["x"]],
  ["colour kept", '<span style="color:#c0392b">x</span>', [], ['style="color:#c0392b"']],
  ["colour kept, rest dropped", '<span style="color:red;position:fixed;top:0">x</span>', ["position", "fixed", "top"], ['style="color:red"']],
  ["rgb colour kept", '<span style="color:rgb(12, 34, 56)">x</span>', [], ["color:rgb(12, 34, 56)"]],
  ["url() in colour dropped", '<span style="color:url(javascript:alert(1))">x</span>', ["url(", "javascript"], ["x"]],
  ["expression() dropped", '<span style="color:expression(alert(1))">x</span>', ["expression"], ["x"]],
  ["background dropped", '<span style="background:url(//evil.test/x)">x</span>', ["background", "evil.test"], ["x"]],
