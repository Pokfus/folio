...
/* …AND TWO SIXTEENTH-CENTURY WITNESSES OF THE INCA WORLD JOIN THEM (Sep 2026, writing wh-611 to
   wh-620).  `Cieza de León refused to believe in the quipu until a lord in the Jauja valley had the
   cords fetched` is a conquest-era eyewitness on a conquest-era subject, which is Ibn Battuta's
   relation to Kilwa exactly — but the last-token mechanism yielded *León* and *Vega* and reported two
   cards for naming a researcher.  Both go in as WHOLE forms for the reason the four above them did:
   `de la Vega` and `León` are living surnames, and only the anchored full name excuses nothing else.
   The corpus cites them 12 and 3 times and always in these exact shapes; the accent is a class
   because an unaccented `Leon` is a spelling a later batch may use. */
