...
def desc(s, per_level):
    ...
    return (
        ...
        'actually meet in written German: the most frequent words beyond B1, taken in order from '
        'a corpus of one million sentences of German news (the Leipzig Corpora Collection\'s '
        ...
        'Wiktionary whose headword is more than one word, ordered by how often it is actually '
        'said. Verbal idioms are the heart of it — jemandem auf den Keks gehen, durch den Kakao '
        'ziehen, Schwein haben — alongside the greetings, the prepositional phrases and the '
        'proverbs. '
