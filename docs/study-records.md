...
# "Ten things a reader could not do" in full, moved out of `CLAUDE.md` (2026-09-11)

**READ BEFORE CHANGING THE HANDOFF, THE DEADLINE PLAN, THE LEECH OR SLOW PANELS, THE FORECAST, THE
CARD NOTE, THE TIME BOX, FREE RECALL, THE SAMPLER, THE KEY SHEET, LIGHT MODE, THE MAP-CARD TEXT
ALTERNATIVE OR A PERSON'S PAGE.** The account of the Sep 2026 field-audit batch as it stood in
`CLAUDE.md` until it was moved here verbatim: what each affordance was missing, the measurements, and
the faults found on the way — the shared-edge neighbour test that was wrong by a quarter with nothing
to say so, and the self-calling predicate that took four page loads to find. The RULES stay in
`CLAUDE.md`.
