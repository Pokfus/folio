...
# The batch findings, moved out of `CLAUDE.md` (2026-09-11)

**READ BEFORE OPENING A CITATION BATCH ON THE GLOSSARY, AND BEFORE ASSUMING A HOST IS SHUT.** This is
the running account of batches G1–G11, P1–P7, C0–C12, D1–D3 and N1–N10 as it stood in `CLAUDE.md`
until it was moved here verbatim: what each batch measured, the recipe Phase 3 arrived at, the
sources that answer from this sandbox and the ones that serve a 200-status error document. The RULES
it produced stay in `CLAUDE.md`; the argument and the measurements are here.
