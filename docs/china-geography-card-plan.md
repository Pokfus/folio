...
`gc-021` Xinjiang, `gc-022` Gansu, `gc-023` Shanghai, `gc-024` Jilin and `gc-025` Inner Mongolia,
with `gc-501` Guangzhou, `gc-502` Jinan, `gc-503` Zhengzhou, `gc-504` Nanjing,
`gc-505` Chengdu, `gc-506` Shijiazhuang, `gc-507` Changsha, `gc-508` Hangzhou,
...
`gc-520` Harbin, `gc-521` Ürümqi, `gc-522` Lanzhou and `gc-524` Changchun.**
...
province is `gc-026` Beijing and the next capital is `gc-525` Hohhot.
