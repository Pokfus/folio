...
`gc-026` Beijing, `gc-027` Tianjin and `gc-028` Hainan, with `gc-501` Guangzhou, `gc-502` Jinan,
...
`gc-528` Haikou and `gc-529` Yinchuan.**
...
province is `gc-029` Ningxia and the next capital is `gc-530` Xining.
