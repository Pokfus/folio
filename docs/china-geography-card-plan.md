...
and `gc-021` Xinjiang, with `gc-501` Guangzhou, `gc-502` Jinan, `gc-503` Zhengzhou,
...
`gc-514` Shenyang, `gc-515` Fuzhou, `gc-516` Xi'an, `gc-517` Guiyang and `gc-518` Taiyuan.**
...
province is `gc-022` Gansu and the next capital is `gc-520` Harbin.
