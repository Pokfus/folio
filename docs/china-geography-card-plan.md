...
`gc-016` Shaanxi, `gc-017` Guizhou, `gc-018` Shanxi, `gc-019` Chongqing and
`gc-020` Heilongjiang, with `gc-501` Guangzhou, `gc-502` Jinan, `gc-503` Zhengzhou,
...
`gc-514` Shenyang, `gc-515` Fuzhou, `gc-516` Xi'an and `gc-517` Guiyang.**
...
province is `gc-021` Xinjiang and the next capital is `gc-518` Taiyuan.
