...
`gc-016` Shaanxi, `gc-017` Guizhou and `gc-018` Shanxi, with `gc-501` Guangzhou, `gc-502` Jinan,
`gc-503` Zhengzhou, `gc-504` Nanjing, `gc-505` Chengdu, `gc-506` Shijiazhuang, `gc-507` Changsha,
`gc-508` Hangzhou, `gc-509` Hefei, `gc-510` Wuhan, `gc-511` Nanning, `gc-512` Kunming,
`gc-513` Nanchang, `gc-514` Shenyang and `gc-515` Fuzhou.**
...
province is `gc-019` Chongqing and the next capital is `gc-516` Xi'an.
