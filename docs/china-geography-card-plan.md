...
`gc-016` Shaanxi, `gc-017` Guizhou, `gc-018` Shanxi and `gc-019` Chongqing, with
...
`gc-511` Nanning, `gc-512` Kunming, `gc-513` Nanchang, `gc-514` Shenyang, `gc-515` Fuzhou and
`gc-516` Xi'an.**
...
province is `gc-020` Heilongjiang and the next capital is `gc-517` Guiyang.
