...
`gc-026` Beijing and `gc-027` Tianjin, with `gc-501` Guangzhou, `gc-502` Jinan, `gc-503` Zhengzhou,
...
province is `gc-028` Hainan and the next capital is `gc-529` Yinchuan.
