...
and `gc-026` Beijing, with `gc-501` Guangzhou, `gc-502` Jinan, `gc-503` Zhengzhou, `gc-504` Nanjing,
...
`gc-520` Harbin, `gc-521` Ürümqi, `gc-522` Lanzhou, `gc-524` Changchun and `gc-525` Hohhot.**
...
province is `gc-027` Tianjin and the next capital is `gc-528` Haikou.
