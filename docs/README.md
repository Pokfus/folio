...
| `greece-refinement-audit.md` | The brief for refining the whole 1,000-card Greece collection: checkable rules, the measured baseline, the collisions with house rules to decide first, and the batch plan. **Not started — batch 0 is tooling.** |
