...
# The E48–E56 batch findings, moved out of `CLAUDE.md` (2026-09-11)

**READ BEFORE ADDING A BOOK OR TOUCHING ANY EXTRACTOR.** The full account of the importer rules as it
stood in `CLAUDE.md` until it was moved here verbatim: what each fault looked like on the page, the
measurements that settled each discriminator, and the generalisations that were tried and do not work.
The RULES stay in `CLAUDE.md`, in their imperative form.
