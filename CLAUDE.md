...
- `docs/china-card-plan.md` — the **1000-card running order for the China collection** (`china`): every
  ...
  see the "CHINA" bullet under "Generating cards & glossary entries". **`cnh-001` to `cnh-270` have
...
| China | `china` | `cnh-` | `docs/china-card-plan.md` | 7 / 39 | 269 cards, `cnh-001` to `cnh-270` with `cnh-070` retired in Sep 2026 — next is `cnh-271`; the collection is open to study |
