...
| Russia (Geography) | `geo-russia` | `gru-` | `docs/russia-geography-card-plan.md` | 2 / 2 | 93 cards — **the 83 federal subjects are COMPLETE** and the capital half is OPEN, `gru-505`, `gru-507`, `gru-508`, `gru-509`, `gru-511`, `gru-512`, `gru-513`, `gru-518`, `gru-521` and `gru-523` being written of the 80 centres; **163 rather than 1000** (83 subjects + 80 centres), sorted by POPULATION; **the capitals are NOT contiguous — a centre is written when its answer sentence can be sourced, so `gru-502`, `gru-503`, `gru-506` and `gru-510` are still to write**, see below |
