...
| Geography | `geo-us` | `geo-` | `docs/geography-card-plan.md` | 3 / 3 | the 50 states and 50 capitals are **COMPLETE**; the third deck, **the largest cities** (`geo-701`–`geo-749`, 33 numbers — the states whose largest city is not the capital), was added Sep 2026 on request — and it is NOT a 1000-card plan, see below |
