...
| Russia (Geography) | `geo-russia` | `gru-` | `docs/russia-geography-card-plan.md` | 2 / 2 | 37 cards, contiguous — next is `gru-038`; **163 rather than 1000** (83 federal subjects + 80 centres), sorted by POPULATION; **the capital half is BLOCKED on a sourcing recipe — read the plan before writing one**, see below |
