...
| Visual Art | `art` | `art-` | `docs/art-card-plan.md` | 9 / 39 | REMOVED AND RESTARTED Sep 2026; 30 cards, contiguous — the Ice Age subdeck and the first ten of `art-neolithic` — next is `art-031`; not a history collection |
