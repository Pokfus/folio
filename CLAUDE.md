...
- `docs/japan-card-plan.md` — the **1000-card running order for the Japan collection** (`japan`): every
  ...
  **The first fifty cards have shipped** (Sep 2026) — `jp-001` to `jp-030`, the whole of `jp-jomon`,
  and `jp-031` to `jp-050`, two thirds of `jp-yayoi` — so the collection is live and its 32 empty
...
| Japan | `japan` | `jp-` | `docs/japan-card-plan.md` | 9 / 34 | 50 cards, contiguous — next is `jp-051` |
