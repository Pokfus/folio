...
- `docs/us-card-plan.md` — the **1000-card running order for the United States collection** (`col-41`):
  ...
  first fifty cards have shipped**, so the collection is live and its 32 empty decks are coming-soon
...
| United States | `col-41` | `us-` | `docs/us-card-plan.md` | 9 / 33 | 50 cards, contiguous — next is `us-051` |
