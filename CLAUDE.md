...
| Visual Art | `art` | `art-` | `docs/art-card-plan.md` | 9 / 39 | REMOVED AND RESTARTED Sep 2026; 20 cards, contiguous — the whole Ice Age subdeck — next is `art-021`; not a history collection |
